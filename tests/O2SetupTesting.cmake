...
function(o2_setup_testing)
  ...
  # Create special script for testing root macros. This script needs LD_LIBRARY_PATH
  if(NOT
     LD_LIBRARY_PATH)
  ...
  configure_file(
    ...
    ${CMAKE_BINARY_DIR}/test-root-macro.sh
    @ONLY)

  # Create tests wrapper (and make it executable)
  configure_file(
    tests-wrapper.sh.in
    ${CMAKE_BINARY_DIR}/tests-wrapper.sh
    @ONLY)
  ...
  add_test(NAME ensure-executable-naming-convention COMMAND ${CMAKE_BINARY_DIR}/ensure-executable-naming-convention.sh
                                                            @ONLY)
