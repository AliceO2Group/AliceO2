...
namespace AliceO2{
  namespace ITS{
    ...
    public:
      ...
      ULong_t GetPixelIndex() const { return fPixelIndex; }
      ...
      void SetPixelIndex(Int_t index) { fPixelIndex = index; }
      ...
      virtual bool operator<(const Digit &other) const {
        if(fChipIndex < other.fChipIndex ||
           (fChipIndex == other.fChipIndex && fPixelIndex < other.fPixelIndex)) return true;
        return false;
      }
