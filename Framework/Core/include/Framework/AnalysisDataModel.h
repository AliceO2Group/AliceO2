...
DECLARE_SOA_EXPRESSION_COLUMN(Pt, pt, float, //!
                            ifnode(nabs(aod::fwdtrack::signed1Pt) < 0.0000001f, o2::constants::math::VeryBig, nabs(1.f / aod::fwdtrack::signed1Pt)));
DECLARE_SOA_EXPRESSION_COLUMN(P, p, float, //!
                            ifnode(nabs(aod::fwdtrack::signed1Pt) < 0.0000001f, o2::constants::math::VeryBig, 0.5f * (ntan(PIQuarter - 0.5f * natan(aod::fwdtrack::tgl)) + 1.f / ntan(PIQuarter - 0.5f * natan(aod::fwdtrack::tgl))) / nabs(aod::fwdtrack::signed1Pt)));
