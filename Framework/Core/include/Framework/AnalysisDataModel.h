...
namespace v002
{
DECLARE_SOA_COLUMN(TOFHitPattern, tofHitPattern, uint16_t); //! Hit pattern for TOF
DECLARE_SOA_DYNAMIC_COLUMN(TOFUpDown, tofUpDown,            //! TOF pattern of match Up-Down
                           [](uint16_t pattern) -> bool {
                             return (pattern & (1 << 0)) != 0;
                           });
DECLARE_SOA_DYNAMIC_COLUMN(TOFLeftRight, tofLeftRight, //! TOF pattern of match Left-Right
                           [](uint16_t pattern) -> bool {
                             return (pattern & (1 << 1)) != 0;
                           });
...
DECLARE_SOA_TABLE_FULL_VERSIONED(StoredTracksExtra_002, "TracksExtra", "AOD", "TRACKEXTRA", 2, // On disk version of TracksExtra, version 2
                                 ...
                                 track::TOFExpTimeKa<track::Length, track::TOFExpMom>,
                                 track::TOFExpTimePr<track::Length, track::TOFExpMom>,
                                 track::v002::TOFUpDown<track::v002::TOFHitPattern>,
                                 track::v002::TOFLeftRight<track::v002::TOFHitPattern>,
