...
DECLARE_SOA_DYNAMIC_COLUMN(IsAtPV, isAtPV, //! Is the track within the beam pipe (= propagated to a collision vertex)
                           [](float x) -> bool { return (std::fabs(x) < o2::constants::geom::XBeamPipeInnerRef); });
...
DECLARE_SOA_TABLE_FULL(StoredTracks, "Tracks", "AOD", "TRACK", //! On disk version of the track parameters at collision vertex
                       ...
                       track::Signed1Pt, track::IsAtPV<track::X>,
