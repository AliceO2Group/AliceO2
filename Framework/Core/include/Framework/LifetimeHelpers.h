...
struct LifetimeHelpers {
  ...
  static ExpirationHandler::Creator enumDrivenCreation(std::size_t first, std::size_t last, std::size_t step, std::size_t inputTimeslice, std::size_t maxTimeSliceId);
