...
BOOST_AUTO_TEST_CASE(TestDDS)
{
  ...
  BOOST_CHECK_EQUAL(ss.str(), R"EXPECTED(<topology name="o2-dataflow">
   <decltask name="A">
       <exe reachable="true">foo --id A --control static --shm-monitor false --log-color false --color false --jobs 4 --severity info --shm-mlock-segment false --shm-segment-id 0 --shm-throw-bad-alloc true --shm-zero-segment false --stacktrace-on-signal all --session dpl_workflow-id --driver-client-backend ws://0.0.0.0:8080 --plugin-search-path $FAIRMQ_ROOT/lib --plugin dds</exe>
   </decltask>
   <decltask name="B">
       <exe reachable="true">foo --id B --control static --shm-monitor false --log-color false --color false --jobs 4 --severity info --shm-mlock-segment false --shm-segment-id 0 --shm-throw-bad-alloc true --shm-zero-segment false --stacktrace-on-signal all --session dpl_workflow-id --driver-client-backend ws://0.0.0.0:8080 --plugin-search-path $FAIRMQ_ROOT/lib --plugin dds</exe>
   </decltask>
   <decltask name="C">
       <exe reachable="true">foo --id C --control static --shm-monitor false --log-color false --color false --jobs 4 --severity info --shm-mlock-segment false --shm-segment-id 0 --shm-throw-bad-alloc true --shm-zero-segment false --stacktrace-on-signal all --session dpl_workflow-id --driver-client-backend ws://0.0.0.0:8080 --plugin-search-path $FAIRMQ_ROOT/lib --plugin dds</exe>
   </decltask>
   <decltask name="D">
       <exe reachable="true">foo --id D --control static --shm-monitor false --log-color false --color false --jobs 4 --severity info --shm-mlock-segment false --shm-segment-id 0 --shm-throw-bad-alloc true --shm-zero-segment false --stacktrace-on-signal all --session dpl_workflow-id --driver-client-backend ws://0.0.0.0:8080 --plugin-search-path $FAIRMQ_ROOT/lib --plugin dds</exe>
   </decltask>
