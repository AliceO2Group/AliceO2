...
void WorkflowHelpers::injectServiceDevices(WorkflowSpec& workflow, ConfigContext const& ctx)
{
  ...
  DataProcessorSpec pidBuilder{
    ...
    // Here are defined the configurable options that are to be used by the auto-PID task
    {{ConfigParamSpec{"aod-file", VariantType::String, "", {"Input AOD file"}},
      ConfigParamSpec{"param-file", VariantType::String, "", {"Path to the parametrization object, if emtpy the parametrization is not taken from file"}},
      ConfigParamSpec{"param-signal", VariantType::String, "BetheBloch", {"Name of the parametrization for the expected signal, used in both file and CCDB mode"}},
      ConfigParamSpec{"param-sigma", VariantType::String, "TPCReso", {"Name of the parametrization for the expected sigma, used in both file and CCDB mode"}},
      ConfigParamSpec{"ccdb-url", VariantType::String, "http://ccdb-test.cern.ch:8080", {"url of the ccdb repository"}},
      ConfigParamSpec{"ccdb-timestamp", VariantType::Int64, -1, {"timestamp of the object"}},
      ConfigParamSpec{"aod-reader-json", VariantType::String, "", {"json configuration file"}},
      ConfigParamSpec{"time-limit", VariantType::Int64, 0ll, {"Maximum run time limit in seconds"}},
      ConfigParamSpec{"start-value-enumeration", VariantType::Int64, 0ll, {"initial value for the enumeration"}},
      ConfigParamSpec{"end-value-enumeration", VariantType::Int64, -1ll, {"final value for the enumeration"}},
