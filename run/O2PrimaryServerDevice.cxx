...
O2PrimaryServerDevice::O2PrimaryServerDevice()
{
...
void O2PrimaryServerDevice::initGenerator()
{
  TStopwatch timer;
  timer.Start();
...
void O2PrimaryServerDevice::generateEvent()
{
...
void O2PrimaryServerDevice::launchInfoThread()
{
...
void O2PrimaryServerDevice::InitTask()
{
...
bool O2PrimaryServerDevice::ReInit(o2::conf::SimReconfigData const& reconfig)
{
...
bool O2PrimaryServerDevice::HandleConfigRequest(fair::mq::Channel& channel)
{
...
bool O2PrimaryServerDevice::ConditionalRun()
{
...
void O2PrimaryServerDevice::PostRun()
{
...
bool O2PrimaryServerDevice::HandleRequest(fair::mq::MessagePtr& request, int /*index*/, fair::mq::Channel& channel)
{
...
void O2PrimaryServerDevice::stateTransition(O2PrimaryServerState to, const char* message)
{
  LOG(info) << message << " CHANGING STATE TO " << PrimStateToString[(int)to];
  mState = to;
}

void O2PrimaryServerDevice::waitForControlInput()
{
