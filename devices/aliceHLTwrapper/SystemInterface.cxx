...
int SystemInterface::InitSystem(unsigned long runNo)
{
  ...
  for (int i=0; arrayCalls[i]!=NULL; i++) {
    ...
    if (call==NULL) {
      ...
      switch (i) {
      case 0: mpAliHLTExtFctInitSystem=(AliHLTExtFctInitSystem)call; break;
      case 1: mpAliHLTExtFctDeinitSystem=(AliHLTExtFctDeinitSystem)call; break;
      case 2: mpAliHLTExtFctLoadLibrary=(AliHLTExtFctLoadLibrary)call; break;
      case 3: mpAliHLTExtFctUnloadLibrary=(AliHLTExtFctUnloadLibrary)call; break;
      case 4: mpAliHLTExtFctCreateComponent=(AliHLTExtFctCreateComponent)call; break;
      case 5: mpAliHLTExtFctDestroyComponent=(AliHLTExtFctDestroyComponent)call; break;
      case 6: mpAliHLTExtFctProcessEvent=(AliHLTExtFctProcessEvent)call; break;
      case 7: mpAliHLTExtFctGetOutputDataType=(AliHLTExtFctGetOutputDataType)call; break;
      case 8: mpAliHLTExtFctGetOutputSize=(AliHLTExtFctGetOutputSize)call; break;
      default:
