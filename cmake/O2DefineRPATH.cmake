...
function(o2_define_rpath)
  ...
  # when building, do not use the install RPATH already (will only be used when actually installing), unless we are on a
  # Mac (where the install is otherwise pretty slow)
  set(CMAKE_BUILD_WITH_INSTALL_RPATH FALSE PARENT_SCOPE)
  if(APPLE)
    set(CMAKE_BUILD_WITH_INSTALL_RPATH TRUE PARENT_SCOPE)
  endif()

  # add to the install RPATH the (automatically determined) parts of the RPATH that point to directories outside the
  # build tree
