...
#
# * INCLUDE_DIRECTORIES the relative path(s) to the headers of that library if not specified will be set as "include"
#   simply (which should work just fine in most cases)
#
function(
  ...
  # set the export name so that packages using O2 can reference the target as O2::${baseTargetName} as well (assuming
  # the export is installed with namespace O2::)
  set_property(
    TARGET ${target}
  ...
  target_include_directories(${target} INTERFACE $<BUILD_INTERFACE:${A_INCLUDE_DIRECTORIES}>)

  if(A_INTERFACE_LINK_LIBRARIES)
    target_link_libraries(${target} INTERFACE ${A_INTERFACE_LINK_LIBRARIES})
  endif()
  install(DIRECTORY ${A_INCLUDE_DIRECTORIES}/ DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
