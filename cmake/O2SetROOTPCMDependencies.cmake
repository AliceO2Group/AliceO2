...
set(O2_TARGETPCMMAP_TARGET "" CACHE INTERNAL "target/PCM map (target)")
set(O2_TARGETPCMMAP_PCM "" CACHE INTERNAL "target/PCM map (pcm)")

function(set_root_pcm_dependencies)
  foreach(target pcm IN ZIP_LISTS O2_TARGETPCMMAP_TARGET O2_TARGETPCMMAP_PCM)
    if (NOT pcm STREQUAL "")
  ...
  foreach(target pcm IN ZIP_LISTS O2_TARGETPCMMAP_TARGET O2_TARGETPCMMAP_PCM)
    if (NOT pcm STREQUAL "")
      ...
      foreach(dep_target IN LISTS dep_targets)
        if (dep_target MATCHES "^O2::")
          string(REPLACE "O2::" "" dep_target ${dep_target})
