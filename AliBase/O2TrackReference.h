#ifndef O2TRACKREFERENCE_H
#define O2TRACKREFERENCE_H
...
class O2TrackReference : public TObject {
  ...
  public:
    ...
    O2TrackReference();
    O2TrackReference(Int_t label, Int_t id = -999);
    O2TrackReference(const O2TrackReference &tr);
    virtual ~O2TrackReference() {}
  
    // static AliExternalTrackParam * MakeTrack(const O2TrackReference *ref, Double_t mass);
    ...
    Int_t Compare(const TObject *obj) const {
      Int_t ll = ((O2TrackReference*)obj)->GetTrack();
  ...
  protected:
    ...
    ClassDef(O2TrackReference,6)  //Base class for all Alice track references
};
#endif
