...
inline bool parse_cmd_line(int _argc, char *_argv[], DeviceOptions *_options)
{
  ...
  desc.add_options()
    ...
    ("hb-out-buff-size", bpo::value<int>()->default_value(100),
     "Heartbeat output buffer size in number of messages (ZeroMQ)/bytes(nanomsg)")
    ...
    ("ack-out-buff-size", bpo::value<int>()->default_value(100),
     "Acknowledgement output buffer size in number of messages (ZeroMQ)/bytes(nanomsg)")
