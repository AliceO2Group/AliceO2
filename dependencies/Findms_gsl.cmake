...
#
# find_package(Microsoft.GSL CONFIG) Which, when successful, will add library target called Microsoft.GSL::GSL which you
# can use via the usual target_link_libraries mechanism.
...
if(TARGET
   Microsoft.GSL::GSL)
  # version >= 3.1 now has a proper Config.cmake file so we use that
  add_library(
    ms_gsl::ms_gsl
    ALIAS
    Microsoft.GSL::GSL)
