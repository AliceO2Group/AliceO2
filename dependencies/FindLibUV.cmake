...
find_path(LibUV_INCLUDE_DIR NAMES uv.h PATHS $ENV{LIBUV_ROOT}/include)
...
if(LibUV_INCLUDE_DIR
   AND EXISTS
       "${LibUV_INCLUDE_DIR}/uv-version.h")
  file(
    STRINGS
    "${LibUV_INCLUDE_DIR}/uv-version.h"
    _LibUV_H
    REGEX "${_LibUV_H_REGEX}")
elseif(
  LibUV_INCLUDE_DIR
  AND EXISTS
      "${LibUV_INCLUDE_DIR}/uv/version.h")
...
endforeach()
if(DEFINED
   _LibUV_VERSION_MAJOR
   AND DEFINED
       _LibUV_VERSION_MINOR)
