...
if(${PKGNAME}_CONFIG)
  ...
  if(${PKGNAME}_CONFIGLIBS)
    ...
    if ("CGAL" IN_LIST ${PKGNAME}_LIBS)
      ...
      if (NOT lib_cgal)
        if (${${PKGNAME}_FIND_REQUIRED})
          message(FATAL_ERROR "CGAL not found in $ENV{CGAL_ROOT}/lib")
        else (${${PKGNAME}_FIND_REQUIRED})
          message(WARNING "FastJet setup incomplete, CGAL not found in $ENV{CGAL_ROOT}/lib")
        endif (${${PKGNAME}_FIND_REQUIRED})
        set (${${PKGNAME}_CONFIG}_INCOMPLETE TRUE)
      endif()
    ...
    if ("gmp" IN_LIST ${PKGNAME}_LIBS)
      ...
      if (NOT lib_gmp)
        if (${${PKGNAME}_FIND_REQUIRED})
          ...
          message(WARNING "FastJet setup incomplete, GMP not found in $ENV{GMP_ROOT}/lib")
        endif (${${PKGNAME}_FIND_REQUIRED})
        set (${${PKGNAME}_CONFIG}_INCOMPLETE TRUE)
      endif()
