...
# Author: Jochen Klein
#
# add FastJet::FastJet as library to targets depending on FastJet, place code depending on FastJet in blocks:
# if(FastJet_FOUND) ... endif() (in cmake) #ifdef HAVE_FASTJET ... #endif (in C++)
...
string(
  TOUPPER ${PKGNAME}
          PKGENVNAME)
string(
  TOLOWER "${PKGNAME}-config"
          PKGCONFIG)

find_program(${PKGNAME}_CONFIG NAMES ${PKGCONFIG} PATHS $ENV{${PKGENVNAME}})
mark_as_advanced(${PKGNAME}_CONFIG)

if(${PKGNAME}_CONFIG)
  execute_process(
    COMMAND ${${PKGNAME}_CONFIG} --cxxflags
