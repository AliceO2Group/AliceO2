...
REQUIRED_VARS ${PKGNAME}_LIBRARY_SHARED ${PKGNAME}_XKBCOMMONLIBRARY_SHARED ${PKGNAME}_INCLUDE_DIR ${PKGNAME}_XKBCOMMON_INCLUDE_DIR ${PKGNAME}_SCANNER ${PKGNAME}_PROTOCOLS_DIR)

if(${PKGNAME}_LIBRARY_SHARED AND ${PKGNAME}_XKBCOMMONLIBRARY_SHARED AND ${PKGNAME}_INCLUDE_DIR AND ${PKGNAME}_XKBCOMMON_INCLUDE_DIR AND ${PKGNAME}_SCANNER AND ${PKGNAME}_PROTOCOLS_DIR)
  ...
  add_library(Wayland::wayland-client ALIAS WAYLAND-all_libraries)
endif()
