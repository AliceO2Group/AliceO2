...
if(ALIBUILD_BASEDIR)
  ...
  o2_find_dependencies_from_alibuild(${ALIBUILD_BASEDIR} LABEL ${ALIBUILD_LABEL} QUIET)
endif()

# Required packages
#
# Order is not completely irrelevant. For instance arrow must come before FairRoot (see FindFairRoot.cmake)
#
# Generally speaking we should prefer the CONFIG variant of the find_package. We explicitely don't use the CONFIG
# variant (i.e. we do use the MODULE variant) only for some packages XXX where we define our own FindXXX.cmake module
# (e.g. to complement and/or fix what's done in the package's XXXConfig.cmake file)
