...
include_guard()
#
# o2_find_dependencies_from_alibuild(basedir ...)  will locate, all our external dependencies from a typical alibuild
# installation.
#
# * basedir : the top directory of the alibuild installation, $HOME/alice/sw/[osname] typically
# * LABEL (`latest` by default) : the label of the installation
#
# In the example below, basedir would be ~/alice/sw/osx_x86-64 and LABEL could be either `label` or
# `label-cmake-reorg-o2`
#
# cmake-format: off
#
# ~/alice/sw
...
function(o2_find_dependencies_from_alibuild)
  ...
  macro(
    ...
    if(DEFINED
      ...
      if(IS_DIRECTORY
        ...
        if(NOT
           A_QUIET)
          message(STATUS "Could not detect ${var}_ROOT from alibuild installation")
        endif()
      endif()
      unset(dir)
      unset(value)
    ...
    if(DEFINED
      ...
      if(IS_DIRECTORY
        ...
        set(${var}_DIR
            ${dir}
            CACHE STRING
                  "location of cmake config for ${pkg}")
        if(NOT
           A_QUIET)
        ...
        if(NOT
           A_QUIET)
          message(STATUS "Could not detect ${var}_DIR from alibuild installation")
        endif()
      endif()
      unset(dir)
    endif()
  ...
  find_program(
    ...
    brew)
  if(brew_CMD)
    execute_process(COMMAND ${brew_CMD} --PREFIX glfw OUTPUT_VARIABLE result OUTPUT_STRIP_TRAILING_WHITESPACE)
  ...
  set(DEPENDENCIES_FROM_ALIBUILD_DONE
      TRUE
      CACHE BOOL
