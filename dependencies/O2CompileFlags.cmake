...
MARK_AS_ADVANCED(O2_SANITIZER_LIST)

IF(ENABLE_CASSERT) #For the CI, we want to have <cassert> assertions enabled
    set(CMAKE_CXX_FLAGS_RELEASE "-O2")
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 -g")
    set(CMAKE_CXX_FLAGS_SANITIZE "-O2 -g ${O2_SANITIZER_LIST}")
ELSE()
    set(CMAKE_CXX_FLAGS_RELEASE "-O2 -DNDEBUG")
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 -g -DNDEBUG")
    set(CMAKE_CXX_FLAGS_SANITIZE "-O2 -g -DNEBUG ${O2_SANITIZER_LIST}")
ENDIF()
...
set(CMAKE_Fortran_FLAGS_SANITIZE "-O2 -g")
...
set(CMAKE_SHARED_LINKER_FLAGS_SANITIZE "${O2_SANITIZER_LIST}")
