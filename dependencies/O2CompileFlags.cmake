...
set(O2_SANITIZER_LIST "-fsanitize=address")
...
set(CMAKE_CXX_FLAGS_SANITIZE "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} ${O2_SANITIZER_LIST}" CACHE STRING "C++ flags for sanitized build" FORCE)
set(CMAKE_C_FLAGS_SANITIZE "${CMAKE_CXX_FLAGS_SANITIZE}" CACHE STRING "C flags for sanitized build" FORCE)
set(CMAKE_Fortran_FLAGS_SANITIZE "-O2 -g" CACHE STRING "Fortran flags for sanitized build" FORCE)
set(CMAKE_LINK_FLAGS_SANITIZE "${O2_SANITIZER_LIST}" CACHE STRING "LD flags for sanitized build" FORCE)

MARK_AS_ADVANCED(
    CMAKE_CXX_FLAGS_SANITIZE
    CMAKE_C_FLAGS_SANITIZE
    CMAKE_Fortran_FLAGS_SANITIZE
    CMAKE_LINK_FLAGS_SANITIZE)
