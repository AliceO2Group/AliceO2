...
string(JOIN " " CMAKE_C_WARNINGS ${O2_C_ENABLED_WARNINGS} ${O2_C_ENABLED_WARNINGS_NO_ERROR} ${O2_NEW_COMPILER_NO_ERROR_FLAGS})
string(JOIN " " CMAKE_CXX_WARNINGS ${O2_CXX_ENABLED_WARNINGS} ${O2_CXX_ENABLED_WARNINGS_NO_ERROR} ${O2_NEW_COMPILER_NO_ERROR_FLAGS})
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  string(APPEND CMAKE_C_WARNINGS " -Wno-unknown-warning-option -Wno-vla-cxx-extension")
  string(APPEND CMAKE_CXX_WARNINGS " -Wno-unknown-warning-option -Wno-vla-cxx-extension")
endif()
