...
function(detect_gpu_arch backend) # Detect GPU architecture, optionally filterring by backend
  ...
  if(CUDA_FIRST_TARGET GREATER_EQUAL 89)
  ...
  if(HIP_FIRST_TARGET_PADDED STRGREATER_EQUAL "1100")
    set(HIP_TARGET RDNA3)
  elseif(HIP_FIRST_TARGET_PADDED STRGREATER_EQUAL "1000")
    set(HIP_TARGET RDNA)
