...
if(ENABLE_HIP)
  ...
  if(EXISTS "${HIP_PATH}")
    ...
    if(hip_FOUND AND hipcub_FOUND AND rocthrust_FOUND AND rocprim_FOUND AND hip_HIPCC_EXECUTABLE)
      ...
      set(O2_HIP_CMAKE_CXX_FLAGS "-mllvm -amdgpu-disable-lower-module-lds=false -fcuda-flush-denormals-to-zero -Wno-invalid-command-line-argument -Wno-unused-command-line-argument -Wno-invalid-constexpr -Wno-ignored-optimization-argument -Wno-unused-private-field")
      if(HIP_AMDGPUTARGET)
