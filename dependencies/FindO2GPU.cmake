...
if(ENABLE_CUDA)
  ...
  if(CMAKE_CUDA_COMPILER)
    ...
    set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -Xcompiler \"${CMAKE_CXX_FLAGS_NOSTD}\" --generate-line-info --expt-relaxed-constexpr --extended-lambda --allow-unsupported-compiler -Xptxas -v")
