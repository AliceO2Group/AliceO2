...
if(ENABLE_HIP)
  ...
  if(EXISTS "${HIP_PATH}")
    ...
    if(hip_FOUND AND hipcub_FOUND AND rocthrust_FOUND AND rocprim_FOUND AND hip_HIPCC_EXECUTABLE)
      ...
      set(O2_HIP_CMAKE_CXX_FLAGS "-fcuda-flush-denormals-to-zero -fgpu-defer-diag -mllvm -amdgpu-enable-lower-module-lds=false -Wno-invalid-command-line-argument -Wno-unused-command-line-argument -Wno-invalid-constexpr -Wno-ignored-optimization-argument -Wno-unused-private-field")
      if(HIP_AMDGPUTARGET)
