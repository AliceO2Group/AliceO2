...
function(cxx14_check_feature FEATURE_NAME RESULT_VAR)
    if (NOT DEFINED ${RESULT_VAR})
        ...
        message(STATUS "_SRCFILE=${_SRCFILE} FEATURE_NAME=${FEATURE_NAME}")
        ...
        if (CROSS_COMPILING)
          ...
          message(STATUS "_bindir=${_bindir} => ${_SRCFILE}")
            try_run(_RUN_RESULT_VAR _COMPILE_RESULT_VAR
                    "${_bindir}" "${_SRCFILE}")
                  message(FATAL_ERROR "_COMPILE_RESULT_VAR=${_COMPILE_RESULT_VAR}")
