...
MCProng::MCProng(int n, const std::vector<int> pdgs, const std::vector<bool> checkBothCharges, const std::vector<bool> excludePDG,
                 ...
                 const std::vector<bool> useANDonSourceBitMap) :
 fPDGcodes(pdgs),
...
//________________________________________________________________________________________________________________  
bool MCProng::TestPDG(int i, int pdgCode) {
...
//________________________________________________________________________________________________________________
bool MCProng::ComparePDG(int pdg, int prongPDG, bool checkBothCharges, bool exclude) {
//
