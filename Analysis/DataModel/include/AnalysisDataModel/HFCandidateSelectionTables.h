...
DECLARE_SOA_TABLE(HFSelJpsiToEECandidate, "AOD", "HFSELJPSIEECAND", //!
                  hf_selcandidate_jpsitoee::IsSelJpsiToEE);

namespace hf_selcandidate_jpsitomumu
{
DECLARE_SOA_COLUMN(IsSelJpsiToMuMu, isSelJpsiToMuMu, int);
} // namespace hf_selcandidate_jpsitomumu
DECLARE_SOA_TABLE(HFSelJpsiToMuMuCandidate, "AOD", "HFSELJPSIMMCAND", //!
                  hf_selcandidate_jpsitomumu::IsSelJpsiToMuMu);
