...
struct DTask {
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    spectra.add("charged/kaons", "Kaons", defaultParticleHist);
    spectra.add("folder1/sigmas", "Sigmas", defaultParticleHist);
  ...
  void process(aod::Tracks const& tracks)
  {
    ...
    for (auto& track : tracks) {
      ...
      spectra.fill("charged/kaons", track.pt(), track.eta(), 50., 0.);
      spectra.fill("folder1/sigmas", track.pt(), track.eta(), 50., 0.);
