...
struct TableReaderSimpleMuon {

  OutputObj<HistogramManager> fHistMan{"MuonsHistos"};
  ...
  void DefineHistograms(TString histClasses)
  {
    ...
    for (Int_t iclass = 0; iclass < arr->GetEntries(); ++iclass) {
      ...
      if (classStr.Contains("Track")) {
        ...
        fHistMan->AddHistogram(classStr.Data(), "Eta", "#eta distribution", false, 19, -4.2, -2.3, VarManager::kEta);                                               // TH1F histogram
...
{
  return WorkflowSpec{
    adaptAnalysisTask<TableReaderSimpleMuon>("table-reader-simple-muon")};
}
