...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  ...
  workflow.push_back(adaptAnalysisTask<DQTableMakerMuonPP<gkEventFillMapNoCent, MyEventsNoCent>>(cfgc, TaskName{"dq-table-maker-muon-pp"}));
  return workflow;
}
