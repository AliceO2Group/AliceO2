...
struct TaskDileptonEE {
  ...
  //constexpr static uint32_t fgTrackFillMap = VarManager::ObjTypes::Track | VarManager::ObjTypes::TrackExtra | VarManager::ObjTypes::ReducedTrack | VarManager::ObjTypes::ReducedTrackBarrel | VarManager::ObjTypes::ReducedTrackBarrelCov | VarManager::ObjTypes::ReducedTrackBarrelPID;
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    fHistMan.setObject(new HistogramManager("analysisHistos", "dielectron", VarManager::kNVars));

    fHistMan->SetUseDefaultVariableNames(kTRUE);
    fHistMan->SetDefaultVarNames(VarManager::fgVariableNames, VarManager::fgVariableUnits);

    DefineHistograms("Event_BeforeCuts;Event_AfterCuts;TrackBarrel_BeforeCuts;TrackBarrel_AfterCuts;PairsBarrel;"); // define all histograms
  ...
  void DefineHistograms(TString histClasses)
  {
    ...
    for (Int_t iclass = 0; iclass < arr->GetEntries(); ++iclass) {
      ...
      if (classStr.Contains("Track")) {
        fHistMan->AddHistClass(classStr.Data());
        fHistMan->AddHistogram(classStr.Data(), "Pt", "p_{T} distribution", false, 100, 0.0, 10.0, VarManager::kPt);                                                   // TH1F histogram
        fHistMan->AddHistogram(classStr.Data(), "Eta", "#eta distribution", false, 200, -1.0, 1.0, VarManager::kEta);                                                  // TH1F histogram
        fHistMan->AddHistogram(classStr.Data(), "Phi_Eta", "#varphi vs #eta distribution", false, 200, -6.3, 6.3, VarManager::kPhi, 200, -1.0, 1.0, VarManager::kEta); // TH2F histogram

        if (classStr.Contains("Barrel")) {
          //fHistMan->AddHistogram(classStr.Data(), "TPCnCR" , "Number of crossed rows in TPC", false, 160, -0.5, 159.5, VarManager::kTPCnCR); // TH1F histogram
          //fHistMan->AddHistogram(classStr.Data(), "TPCnF" , "Number of crossed rows in TPC", false, 160, -0.5, 159.5, VarManager::kTPCnF); // TH1F histogram
          //fHistMan->AddHistogram(classStr.Data(), "TPCnCRoverF" , "Number of crossed rows in TPC", false, 200, 0., 2, VarManager::kTPCnCRoverF); // TH1F histogram
          ...
          //for TPC PID
          fHistMan->AddHistogram(classStr.Data(), "TPCdedx_pIN", "TPC dE/dx vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, 0.0, 200., VarManager::kTPCsignal);                    // TH2F histogram
          fHistMan->AddHistogram(classStr.Data(), "TPCnSigmaEl_pIN", "TPC dE/dx n#sigma_{e} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTPCnSigmaEl);   // TH2F histogram
          ...
          fHistMan->AddHistogram(classStr.Data(), "TPCnSigmaPi_pIN", "TPC dE/dx n#sigma_{#pi} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTPCnSigmaPi); // TH2F histogram
          ...
          fHistMan->AddHistogram(classStr.Data(), "TPCnSigmaKa_pIN", "TPC dE/dx n#sigma_{K} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTPCnSigmaKa);   // TH2F histogram
          ...
          fHistMan->AddHistogram(classStr.Data(), "TPCnSigmaPr_pIN", "TPC dE/dx n#sigma_{p} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTPCnSigmaPr);   // TH2F histogram
          ...
          //for TOF PID
          fHistMan->AddHistogram(classStr.Data(), "TOFbeta_pIN", "TOF #beta vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 120, 0.0, 1.2, VarManager::kTOFbeta);                       // TH2F histogram
          fHistMan->AddHistogram(classStr.Data(), "TOFnSigmaEl_pIN", "TOF #beta n#sigma_{e} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTOFnSigmaEl);   // TH2F histogram
          ...
          fHistMan->AddHistogram(classStr.Data(), "TOFnSigmaPi_pIN", "TOF #beta n#sigma_{#pi} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTOFnSigmaPi); // TH2F histogram
          ...
          fHistMan->AddHistogram(classStr.Data(), "TOFnSigmaKa_pIN", "TOF #beta n#sigma_{K} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTOFnSigmaKa);   // TH2F histogram
          ...
          fHistMan->AddHistogram(classStr.Data(), "TOFnSigmaPr_pIN", "TOF #beta n#sigma_{p} vs pIN", false, 1000, 0.0, 10.0, VarManager::kPin, 200, -10, +10, VarManager::kTOFnSigmaPr);   // TH2F histogram
      ...
      if (classStr.Contains("Pairs")) {
        fHistMan->AddHistClass(classStr.Data());
        fHistMan->AddHistogram(classStr.Data(), "MvsPt", "M_{ee} vs. p_{T,ee};#it{m}_{ee} (GeV/#it{c}^{2});#it{p}_{T,ee} (GeV/#it{c})", false, 500, 0.0, 5.0, VarManager::kMass, 200, 0.0, 20.0, VarManager::kPt);
      }
...
{
  return WorkflowSpec{
    adaptAnalysisTask<TaskDileptonEE>("dilepton-ee")};
}
