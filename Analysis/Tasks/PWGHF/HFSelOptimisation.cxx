    ...
    for (int iOrig{0}; iOrig < 3; iOrig++) {
      for (int i2Prong = 0; i2Prong < n2Prong + 1; ++i2Prong) {
        ...
        for (int iBin{0}; iBin < histCosp2Prong->GetYaxis()->GetNbins(); ++iBin) {
          histCosp2Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.4f", cutsToTestCosp->at(iBin)));
        }
        ...
        for (int iBin{0}; iBin < histDecLen2Prong->GetYaxis()->GetNbins(); ++iBin) {
          histDecLen2Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.3f", cutsToTestDecLen->at(iBin)));
        }
        ...
        for (int iBin{0}; iBin < histImpParProd2Prong->GetYaxis()->GetNbins(); ++iBin) {
          histImpParProd2Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.4f", cutsToTestImpParProd->at(iBin)));
        }
        ...
        for (int iBin{0}; iBin < histMinDCAxy2Prong->GetYaxis()->GetNbins(); ++iBin) {
          histMinDCAxy2Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.4f", cutsToTestMinDCAxy->at(iBin)));
        }
        ...
        for (int iBin{0}; iBin < histMinTrackPt2Prong->GetYaxis()->GetNbins(); ++iBin) {
          histMinTrackPt2Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.2f", cutsToTestMinTrackPt->at(iBin)));
        }
      }
      for (int i3Prong{0}; i3Prong < n3Prong + 1; ++i3Prong) {
        ...
        for (int iBin{0}; iBin < histCosp3Prong->GetYaxis()->GetNbins(); ++iBin) {
          histCosp3Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.4f", cutsToTestCosp->at(iBin)));
        }
        ...
        for (int iBin{0}; iBin < histDecayLen3Prong->GetYaxis()->GetNbins(); ++iBin) {
          histDecayLen3Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.4f", cutsToTestDecLen->at(iBin)));
        }
        ...
        for (int iBin{0}; iBin < histMinDCAxy3Prong->GetYaxis()->GetNbins(); ++iBin) {
          histMinDCAxy3Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.4f", cutsToTestMinDCAxy->at(iBin)));
        }
        auto histMinTrackPt3Prong = std::get<std::shared_ptr<TH2>>(registry.add(histoNamesMinTrackPt3Prong[iOrig][i3Prong].data(), "", HistType::kTH2F, {axisPt, axisMinTrackPt}));
        for (int iBin{0}; iBin < histMinTrackPt3Prong->GetYaxis()->GetNbins(); ++iBin) {
          histMinTrackPt3Prong->GetYaxis()->SetBinLabel(iBin + 1, Form("%0.4f", cutsToTestMinTrackPt->at(iBin)));
        }
      }
    }
  }
