...
o2fw::WorkflowSpec defineDataProcessing(o2fw::ConfigContext const& cfgc)
{
  ...
  if (cfgc.options().get<int>("eff-el")) {
    w.push_back(o2fw::adaptAnalysisTask<QATrackingEfficiencyPt<o2::track::PID::Electron>>(cfgc, TaskName{"qa-tracking-efficiency-electron"}));
  }
  if (cfgc.options().get<int>("eff-mu")) {
    w.push_back(o2fw::adaptAnalysisTask<QATrackingEfficiencyPt<o2::track::PID::Muon>>(cfgc, TaskName{"qa-tracking-efficiency-muon"}));
  }
  if (cfgc.options().get<int>("eff-pi")) {
    w.push_back(o2fw::adaptAnalysisTask<QATrackingEfficiencyPt<o2::track::PID::Pion>>(cfgc, TaskName{"qa-tracking-efficiency-pion"}));
  }
  if (cfgc.options().get<int>("eff-ka")) {
    w.push_back(o2fw::adaptAnalysisTask<QATrackingEfficiencyPt<o2::track::PID::Kaon>>(cfgc, TaskName{"qa-tracking-efficiency-kaon"}));
  }
  if (cfgc.options().get<int>("eff-pr")) {
    w.push_back(o2fw::adaptAnalysisTask<QATrackingEfficiencyPt<o2::track::PID::Proton>>(cfgc, TaskName{"qa-tracking-efficiency-proton"}));
  }
  return w;
}
