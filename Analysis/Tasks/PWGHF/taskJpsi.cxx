...
struct TaskJpsiMC {
  ...
  void init(o2::framework::InitContext&)
  {
    registry.add("hMassSig", "2-prong candidates signal;inv. mass (e^{#plus} e^{#minus}) (GeV/#it{c}^{2});entries", {HistType::kTH2F, {{500, 0., 5.}, {(std::vector<double>)bins, "#it{p}_{T} (GeV/#it{c})"}}});
  }
