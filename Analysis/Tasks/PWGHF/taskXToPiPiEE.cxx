...
struct TaskX {
  ...
  Configurable<int> selectionFlagJpsiToEE{"selectionFlagJpsiToEE", 1, "Selection Flag for JpsiToEE"};
  Configurable<double> cutYCandMax{"cutYCandMax", -1., "max. cand. rapidity"};

  Filter filterSelectCandidates = (aod::hf_selcandidate_jpsitoee::isSelJpsiToEE >= selectionFlagJpsiToEE);
