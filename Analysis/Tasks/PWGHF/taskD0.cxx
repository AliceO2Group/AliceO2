...
struct TaskD0 {
  ...
  OutputObj<TH1F> hCTS{TH1F("hCTS", "2-prong candidates;cos #it{#theta}*;entries", 120, -1.1, 1.1)};
  OutputObj<TH1F> hCt{TH1F("hCt", "2-prong candidates;proper lifetime * #it{c} (cm);entries", 120, -20., 100.)};
