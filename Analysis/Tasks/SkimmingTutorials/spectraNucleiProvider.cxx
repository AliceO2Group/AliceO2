...
struct NucleiSpectraProviderTask {
  ...
  using TrackCandidates = soa::Filtered<soa::Join<aod::Tracks, aod::TracksExtra, aod::pidRespTPC, aod::pidRespTOFPi, aod::pidRespTOFKa, aod::pidRespTOFPr, aod::pidRespTOFHe, aod::TrackSelection>>;
