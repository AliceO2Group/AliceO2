...
struct pidTOFTaskQA {
  ...
  Configurable<int> nBinsP{"nBinsP", 250, "Number of bins for the momentum"};
  ...
  Configurable<float> MinDelta{"MinDelta", -1000f, "Minimum Delta in range"};
  Configurable<float> MaxDelta{"MaxDelta", 1000f, "Maximum Delta in range"};
  Configurable<int> nBinsNSigma{"nBinsNSigma", 200, "Number of bins for the NSigma"};
  Configurable<float> MinNSigma{"MinNSigma", -10f, "Minimum NSigma in range"};
  Configurable<float> MaxNSigma{"MaxNSigma", 10f, "Maximum NSigma in range"};
