...
MEM_CLASS_PRE() void MEM_LG(AliGPUCAParam)::Global2Slice( int iSlice, float X, float Y, float Z, float *x, float *y, float *z ) const
{
...
MEM_CLASS_PRE() GPUd() float MEM_LG(AliGPUCAParam)::GetClusterRMS( int yz, int type, float z, float angle2 ) const
{
...
MEM_CLASS_PRE() GPUd() void MEM_LG(AliGPUCAParam)::GetClusterRMS2( int iRow, float z, float sinPhi, float DzDs, float &ErrY2, float &ErrZ2 ) const
{
...
MEM_CLASS_PRE() GPUd() float MEM_LG(AliGPUCAParam)::GetClusterError2( int yz, int type, float z, float angle2 ) const
{
  //* recalculate the cluster error wih respect to the track slope
...
MEM_CLASS_PRE() GPUd() void MEM_LG(AliGPUCAParam)::GetClusterErrors2( int iRow, float z, float sinPhi, float DzDs, float &ErrY2, float &ErrZ2 ) const
{
