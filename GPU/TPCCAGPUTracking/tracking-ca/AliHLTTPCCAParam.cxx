...
GPUdi() AliHLTTPCCAParam::AliHLTTPCCAParam()
    ...
    fConstBz( -5.00668*0.000299792458 ), fHitPickUpFactor( 1. ),
      ...
      fMinNTrackClusters( -1 ), fMaxTrackQPt(1./MIN_TRACK_PT_DEFAULT), fHighQPtForward(1.e10), fNWays(1), fNWaysOuter(0), fSearchWindowDZDR(0.), fContinuousTracking(false), fTrackReferenceX(1000.)
{
  // constructor
