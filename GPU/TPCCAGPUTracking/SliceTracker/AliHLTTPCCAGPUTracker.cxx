...
int AliHLTTPCCAGPUTracker::InitGPU(int /*forceDeviceID*/) { return(1); }
...
int AliHLTTPCCAGPUTracker::Reconstruct(AliHLTTPCCASliceOutput** /*pTracker*/, AliHLTTPCCAClusterData* /*pClusterData*/) {return(1);}
