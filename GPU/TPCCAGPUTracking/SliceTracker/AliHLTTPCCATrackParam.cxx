...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliHLTTPCCATrackParam)::GetDist2(const MEM_LG(AliHLTTPCCATrackParam) & t) const
{
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliHLTTPCCATrackParam)::GetDistXZ2(const MEM_LG(AliHLTTPCCATrackParam) & t) const
{
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliHLTTPCCATrackParam)::GetS(float x, float y, float Bz) const
{
...
MEM_CLASS_PRE()
GPUd() void MEM_LG(AliHLTTPCCATrackParam)::GetDCAPoint(float x, float y, float z,
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::TransportToX(float x, AliHLTTPCCATrackLinearisation &t0, float Bz, float maxSinPhi, float *DL)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::TransportToX(float x, float sinPhi0, float cosPhi0, float Bz, float maxSinPhi)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::TransportToX(float x, float Bz, float maxSinPhi)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::TransportToXWithMaterial(float x, AliHLTTPCCATrackLinearisation &t0, AliHLTTPCCATrackFitParam &par, float Bz, float maxSinPhi)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::TransportToXWithMaterial(float x, AliHLTTPCCATrackFitParam &par, float Bz, float maxSinPhi)
{
	//* Transport the track parameters to X=x  taking into account material budget
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::TransportToXWithMaterial(float x, float Bz, float maxSinPhi)
{
	//* Transport the track parameters to X=x taking into account material budget
...
//*
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliHLTTPCCATrackParam)::BetheBlochGeant(float bg2,
                                                            float kp0,
                                                            float kp1,
                                                            float kp2,
                                                            float kp3,
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliHLTTPCCATrackParam)::BetheBlochSolid(float bg)
{
	//------------------------------------------------------------------
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliHLTTPCCATrackParam)::BetheBlochGas(float bg)
{
	//------------------------------------------------------------------
	// This is an approximation of the Bethe-Bloch formula,
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliHLTTPCCATrackParam)::ApproximateBetheBloch(float beta2)
{
	//------------------------------------------------------------------
...
MEM_CLASS_PRE()
GPUd() void MEM_LG(AliHLTTPCCATrackParam)::CalculateFitParameters(AliHLTTPCCATrackFitParam &par, float mass)
{
	//*!
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::CorrectForMeanMaterial(float xOverX0, float xTimesRho, const AliHLTTPCCATrackFitParam &par)
{
	//------------------------------------------------------------------
...
//*
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::Rotate(float alpha, float maxSinPhi)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::Rotate(float alpha, AliHLTTPCCATrackLinearisation &t0, float maxSinPhi)
{
	//* Rotate the coordinate system in XY on the angle alpha
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::Filter(float y, float z, float err2Y, float err2Z, float maxSinPhi, bool paramOnly)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliHLTTPCCATrackParam)::CheckNumericalQuality() const
{
...
MEM_CLASS_PRE()
GPUd() void MEM_LG(AliHLTTPCCATrackParam)::Print() const
{
	//* print parameters
