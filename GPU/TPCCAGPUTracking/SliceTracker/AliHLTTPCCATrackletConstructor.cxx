...
MEM_CLASS_PRE2()
GPUd() void AliHLTTPCCATrackletConstructor::InitTracklet(MEM_LG2(AliHLTTPCCATrackParam) & tParam)
{
...
MEM_CLASS_PRE2()
GPUd() bool AliHLTTPCCATrackletConstructor::CheckCov(MEM_LG2(AliHLTTPCCATrackParam) & tParam)
{
	bool ok = 1;
...
MEM_CLASS_PRE23()
GPUd() void AliHLTTPCCATrackletConstructor::StoreTracklet(int /*nBlocks*/, int /*nThreads*/, int /*iBlock*/, int /*iThread*/,
...
MEM_CLASS_PRE2()
GPUd() void AliHLTTPCCATrackletConstructor::UpdateTracklet(int /*nBlocks*/, int /*nThreads*/, int /*iBlock*/, int /*iThread*/,
...
GPUd() void AliHLTTPCCATrackletConstructor::DoTracklet(GPUconstant() MEM_CONSTANT(AliHLTTPCCATracker) & tracker, GPUsharedref() AliHLTTPCCATrackletConstructor::MEM_LOCAL(AliHLTTPCCASharedMemory) & s, AliHLTTPCCAThreadMemory &r)
{
	int iRow = 0, iRowEnd = HLTCA_ROW_COUNT;
	MEM_PLAIN(AliHLTTPCCATrackParam)
	tParam;
#ifndef EXTERN_ROW_HITS
	AliHLTTPCCATracklet &tracklet = tracker.Tracklets()[r.fItr];
#endif //EXTERN_ROW_HITS
...
GPUd() int AliHLTTPCCATrackletConstructor::AliHLTTPCCATrackletConstructorGlobalTracking(AliHLTTPCCATracker &tracker, AliHLTTPCCATrackParam &tParam, int row, int increment, int iTracklet)
{
	AliHLTTPCCAThreadMemory rMem;
	GPUshared() AliHLTTPCCASharedMemory sMem;
	sMem.fNTracklets = *tracker.NTracklets();
	...
	rMem.fGo = 1;
	while (rMem.fGo && row >= 0 && row < HLTCA_ROW_COUNT)
	{
