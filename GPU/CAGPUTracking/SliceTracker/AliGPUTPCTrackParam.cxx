...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliGPUTPCTrackParam)::GetDist2(const MEM_LG(AliGPUTPCTrackParam) & t) const
{
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliGPUTPCTrackParam)::GetDistXZ2(const MEM_LG(AliGPUTPCTrackParam) & t) const
{
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliGPUTPCTrackParam)::GetS(float x, float y, float Bz) const
{
...
MEM_CLASS_PRE()
GPUd() void MEM_LG(AliGPUTPCTrackParam)::GetDCAPoint(float x, float y, float z,
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::TransportToX(float x, AliGPUTPCTrackLinearisation &t0, float Bz, float maxSinPhi, float *DL)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::TransportToX(float x, float sinPhi0, float cosPhi0, float Bz, float maxSinPhi)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::TransportToX(float x, float Bz, float maxSinPhi)
{
	//* Transport the track parameters to X=x
	AliGPUTPCTrackLinearisation t0(*this);
	return TransportToX(x, t0, Bz, maxSinPhi);
}

MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::TransportToXWithMaterial(float x, AliGPUTPCTrackLinearisation &t0, AliGPUTPCTrackFitParam &par, float Bz, float maxSinPhi)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::TransportToXWithMaterial(float x, AliGPUTPCTrackFitParam &par, float Bz, float maxSinPhi)
{
	//* Transport the track parameters to X=x  taking into account material budget
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::TransportToXWithMaterial(float x, float Bz, float maxSinPhi)
{
	//* Transport the track parameters to X=x taking into account material budget

	AliGPUTPCTrackFitParam par;
...
//*
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliGPUTPCTrackParam)::BetheBlochGeant(float bg2,
                                                            float kp0,
                                                            float kp1,
                                                            float kp2,
                                                            float kp3,
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliGPUTPCTrackParam)::BetheBlochSolid(float bg)
{
	//------------------------------------------------------------------
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliGPUTPCTrackParam)::BetheBlochGas(float bg)
{
	//------------------------------------------------------------------
	// This is an approximation of the Bethe-Bloch formula,
...
MEM_CLASS_PRE()
GPUd() float MEM_LG(AliGPUTPCTrackParam)::ApproximateBetheBloch(float beta2)
{
	//------------------------------------------------------------------
...
MEM_CLASS_PRE()
GPUd() void MEM_LG(AliGPUTPCTrackParam)::CalculateFitParameters(AliGPUTPCTrackFitParam &par, float mass)
{
	//*!
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::CorrectForMeanMaterial(float xOverX0, float xTimesRho, const AliGPUTPCTrackFitParam &par)
{
	//------------------------------------------------------------------
...
//*
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::Rotate(float alpha, float maxSinPhi)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::Rotate(float alpha, AliGPUTPCTrackLinearisation &t0, float maxSinPhi)
{
	//* Rotate the coordinate system in XY on the angle alpha
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::Filter(float y, float z, float err2Y, float err2Z, float maxSinPhi, bool paramOnly)
{
...
MEM_CLASS_PRE()
GPUd() bool MEM_LG(AliGPUTPCTrackParam)::CheckNumericalQuality() const
{
...
MEM_CLASS_PRE()
GPUd() void MEM_LG(AliGPUTPCTrackParam)::Print() const
{
	//* print parameters
