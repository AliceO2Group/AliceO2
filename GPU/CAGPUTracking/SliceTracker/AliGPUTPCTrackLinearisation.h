 ...
 *
 * AliGPUTPCTrackLinearisation class describes the parameters which are used
 ...
 * the track trajectory itself (AliGPUTPCTrackLinearisation = AliHLTTPCTrackParam ).
 *
 */
class AliGPUTPCTrackLinearisation
{
  public:
	AliGPUTPCTrackLinearisation() : fSinPhi( 0 ), fCosPhi( 1 ), fDzDs( 0 ), fQPt( 0 ) {}
	AliGPUTPCTrackLinearisation( float SinPhi1, float CosPhi1, float DzDs1, float QPt1 ) : fSinPhi( SinPhi1 ), fCosPhi( CosPhi1 ), fDzDs( DzDs1 ), fQPt( QPt1 ) {}

	GPUd() MEM_CLASS_PRE2() AliGPUTPCTrackLinearisation( const MEM_LG2(AliGPUTPCTrackParam) &t );
...
GPUd() MEM_CLASS_PRE2() inline AliGPUTPCTrackLinearisation::AliGPUTPCTrackLinearisation( const MEM_LG2(AliGPUTPCTrackParam) &t )
...
GPUd() inline void AliGPUTPCTrackLinearisation::Set( float SinPhi1, float CosPhi1,
