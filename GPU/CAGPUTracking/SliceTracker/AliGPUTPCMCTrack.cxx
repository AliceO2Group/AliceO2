...
#include "AliGPUTPCMCTrack.h"
#include "AliTPCCommonMath.h"
#include "TDatabasePDG.h"
#include "TParticle.h"

AliGPUTPCMCTrack::AliGPUTPCMCTrack()
...
AliGPUTPCMCTrack::AliGPUTPCMCTrack(const TParticle *part)
    : fPDG(0), fP(0), fPt(0), fNHits(0), fNMCPoints(0), fFirstMCPointID(0), fNReconstructed(0), fSet(0), fNTurns(0)
{
...
void AliGPUTPCMCTrack::SetTPCPar(float X, float Y, float Z,
