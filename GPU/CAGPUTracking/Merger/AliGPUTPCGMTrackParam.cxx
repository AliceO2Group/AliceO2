...
GPUd() void AliGPUTPCGMTrackParam::MirrorTo(AliGPUTPCGMPropagator& prop, float toY, float toZ, bool inFlyDirection, const AliGPUCAParam& param, unsigned char row, unsigned char clusterState, bool mirrorParameters)
{
...
GPUd() int AliGPUTPCGMTrackParam::MergeDoubleRowClusters(int ihit, int wayDirection, AliGPUTPCGMMergedTrackHit* clusters, const AliGPUCAParam &param, AliGPUTPCGMPropagator& prop, float& xx, float& yy, float& zz, int maxN, float clAlpha, unsigned char& clusterState, bool rejectChi2)
{
