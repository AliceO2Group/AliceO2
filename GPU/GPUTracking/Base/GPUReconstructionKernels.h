...
GPUCA_KRNL((GPUTPCGMMergerUnpack                         ), (simple, REG, (GPUCA_LB_GPUTPCGMMergerUnpack)), (, int iSlice), (, iSlice))
...
GPUCA_KRNL((GPUTPCGMMergerMergeWithin                    ), (simple, REG, (GPUCA_LB_GPUTPCGMMergerMergeWithin)), (), ())
GPUCA_KRNL((GPUTPCGMMergerMergeSlices                    ), (simple, REG, (GPUCA_LB_GPUTPCGMMergerMergeSlices)), (, int border0, int border1, char useOrigTrackParam), (, border0, border1, useOrigTrackParam))
GPUCA_KRNL((GPUTPCGMMergerMergeCE                        ), (simple, REG, (GPUCA_LB_GPUTPCGMMergerMergeCE)), (), ())
GPUCA_KRNL((GPUTPCGMMergerMergeCEInit                    ), (simple, REG, (GPUCA_LB_GPUTPCGMMergerMergeCEInit)), (), ())
