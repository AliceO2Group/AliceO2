...
GPUCA_KRNL((GPUTPCGMMergerMergeBorders, step1            ), (simple, REG, (GPUCA_LB_GPUTPCGMMergerMergeBorders_step1)), (, int iSlice, char withinSlice, char mergeMode), (, iSlice, withinSlice, mergeMode))
