...
GPUCA_KRNL_LB((GPUTPCCFChargeMapFiller,    resetMaps        ), (single), (), ())
...
GPUCA_KRNL_LB((GPUTPCCFStreamCompaction,   nativeScanUpStart), (single), (, int iBuf, int stage), (, iBuf, stage))
GPUCA_KRNL_LB((GPUTPCCFStreamCompaction,   nativeScanUp     ), (single), (, int iBuf, int nElems), (, iBuf, nElems))
GPUCA_KRNL_LB((GPUTPCCFStreamCompaction,   nativeScanTop    ), (single), (, int iBuf, int nElems), (, iBuf, nElems))
