#ifndef ALIGPUSETTINGS_H
#define ALIGPUSETTINGS_H

#include "AliGPUCommonMath.h"
class AliGPUDisplayBackend;

class AliGPUSettings
{
public:
};
...
{
#ifndef GPUCA_GPUCODE
	AliGPUSettingsEvent() {SetDefaults();}
	void SetDefaults();
#endif
...
struct AliGPUSettingsProcessing
{
#ifndef GPUCA_GPUCODE
	AliGPUSettingsProcessing() {SetDefaults();}
	void SetDefaults();
#endif
...
struct AliGPUSettingsDeviceProcessing
{
	#ifndef GPUCA_GPUCODE
		AliGPUSettingsDeviceProcessing() {SetDefaults();}
		void SetDefaults();
	#endif
	...
	AliGPUDisplayBackend* eventDisplay;		//Run event display after processing, ptr to backend
