...
void GPUDisplayBackendGlfw::error_callback(int error, const char* description)
{
...
void GPUDisplayBackendGlfw::scroll_callback(GLFWwindow* window, double x, double y)
{
	me->mouseWheel += y * 100;
}
...
void GPUDisplayBackendGlfw::resize_callback(GLFWwindow* window, int width, int height)
{
...
void GPUDisplayBackendGlfw::SetVSync(bool enable)
{
