#ifndef ALIGPUDISPLAYBACKENDGLUT_H
#define ALIGPUDISPLAYBACKENDGLUT_H

#include "AliGPUDisplayBackend.h"
#include <pthread.h>

class AliGPUDisplayBackendGlut : public AliGPUDisplayBackend
{
public:
	AliGPUDisplayBackendGlut() = default;
	virtual ~AliGPUDisplayBackendGlut() = default;
