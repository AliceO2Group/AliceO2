#ifndef ALIGPUDISPLAYBACKEND_H
#define ALIGPUDISPLAYBACKEND_H

class AliGPUReconstruction;
class AliGPUDisplay;

class AliGPUDisplayBackend
{
	friend class AliGPUDisplay;
public:
	AliGPUDisplayBackend() = default;
	virtual ~AliGPUDisplayBackend() = default;
...
protected:
	...
	AliGPUDisplay* mDisplay; //Ptr to display, not owning, set by display when it connects to backend
