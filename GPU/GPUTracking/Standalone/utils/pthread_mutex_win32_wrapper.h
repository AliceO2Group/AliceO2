...
static inline int pthread_create(pthread_t* thread, const void* attr, void* (*start_routine)(void*), void* arg) { return ((*thread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)start_routine, arg, 0, NULL)) == 0); }
...
static inline int sem_post(sem_t* sem) { return (ReleaseSemaphore(*sem, 1, NULL) == 0); }
