...
BeginSubConfig(GPUSettingsRec, configRec, configStandalone, "REC", 0, "Reconstruction settings")
...
AddOption(deviceNum, int, -1, "gpuDevice", 0, "Set GPU device to use (-1: automatic)")
...
BeginSubConfig(GPUSettingsTF, configTF, configStandalone, "TF", 't', "Timeframe settings")
...
BeginSubConfig(GPUSettingsQA, configQA, configStandalone, "QA", 'q', "QA settings")
...
AddSubConfig(GPUSettingsTF, configTF)
AddSubConfig(GPUSettingsQA, configQA)
