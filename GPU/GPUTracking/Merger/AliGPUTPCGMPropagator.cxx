...
GPUd() void AliGPUTPCGMPropagator::GetErr2(float& err2Y, float& err2Z, const AliGPUParam &param, float posZ, int iRow, short clusterState) const
{
...
GPUd()float AliGPUTPCGMPropagator::PredictChi2(float posY, float posZ, int iRow, const AliGPUParam &param, short clusterState) const
{
	float err2Y, err2Z;
...
GPUd() int AliGPUTPCGMPropagator::Update(float posY, float posZ, int iRow, const AliGPUParam &param, short clusterState, bool rejectChi2, bool refit)
{
	float err2Y, err2Z;
	GetErr2(err2Y, err2Z, param, posZ, iRow, clusterState);
