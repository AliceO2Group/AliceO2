// $Id: GPUTPCGMPhysicalTrackModel.cxx 41769 2010-06-16 13:58:00Z sgorbuno $
// **************************************************************************
...
{
#if !defined(GPUCA_GPUCODE)
	std::cout << "GPUTPCGMPhysicalTrackModel:  x " << fX << " y " << fY << " z " << fZ << " px " << fPx << " py " << fPy << " pz " << fPz << " q " << fQ << std::endl;
#endif
}
