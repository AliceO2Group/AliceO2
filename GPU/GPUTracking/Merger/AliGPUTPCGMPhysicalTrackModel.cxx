// $Id: AliGPUTPCGMPhysicalTrackModel.cxx 41769 2010-06-16 13:58:00Z sgorbuno $
// **************************************************************************
...
GPUd() int AliGPUTPCGMPhysicalTrackModel::PropagateToXBzLightNoUpdate(float x, float Bz, float &dLp)
{
	//
...
GPUd() int AliGPUTPCGMPhysicalTrackModel::PropagateToLpBz(float Lp, float Bz)
{
...
GPUd() void AliGPUTPCGMPhysicalTrackModel::Print() const
{
#if !defined(GPUCA_GPUCODE)
	std::cout << "AliGPUTPCGMPhysicalTrackModel:  x " << fX << " y " << fY << " z " << fZ << " px " << fPx << " py " << fPy << " pz " << fPz << " q " << fQ << std::endl;
#endif
}
