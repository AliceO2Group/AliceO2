 ...
 */
  static int GetPolynomialField(float nominalFieldkG, o2::gpu::GPUTPCGMPolynomialField& field);

#if defined(GPUCA_ALIROOT_LIB) & !defined(GPUCA_GPUCODE)

  /* Get pre-calculated polynomial field for the current ALICE field (if exists)
 */
  static int GetPolynomialField(o2::gpu::GPUTPCGMPolynomialField& field);

  /* Fit given field for TPC
 */
  static int FitFieldTpc(AliMagF* fld, o2::gpu::GPUTPCGMPolynomialField& field, double step = 1.);

  /* Fit given field for TRD
 */
  static int FitFieldTrd(AliMagF* fld, o2::gpu::GPUTPCGMPolynomialField& field, double step = 1.);

  /* Fit given field for ITS
 */
  static int FitFieldIts(AliMagF* fld, o2::gpu::GPUTPCGMPolynomialField& field, double step = 1.);

#endif

  /* Get pre-calculated polynomial field of type "type", scaled with respect to nominalFieldkG
 */
  static int GetPolynomialField(StoredField_t type, float nominalFieldkG, o2::gpu::GPUTPCGMPolynomialField& field);
};
