...
GPUTPCGMMerger::GPUTPCGMMerger()
  : mField(), mTrackLinks(nullptr), mNMaxSliceTracks(0), mNMaxTracks(0), mNMaxSingleSliceTracks(0), mNMaxOutputTrackClusters(0), mNMaxClusters(0), mMemoryResMerger(-1), mMemoryResRefit(-1), mMaxID(0), mNClusters(0), mNOutputTracks(0), mNOutputTrackClusters(0), mOutputTracks(0), mSliceTrackInfos(0), mClusters(nullptr), mGlobalClusterIDs(nullptr), mClusterAttachment(nullptr), mTrackOrder(nullptr), mTmpMem(0), mBorderMemory(0), mBorderRangeMemory(0), mSliceTrackers(nullptr), mChainTracking(nullptr)
{
  //* constructor
