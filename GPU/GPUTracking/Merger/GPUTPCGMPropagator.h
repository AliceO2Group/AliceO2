...
class GPUTPCGMPropagator
{
 public:
  ...
  GPUd() static void GetErr2(float& err2Y, float& err2Z, const GPUParam& param, float snp, float tgl, float posZ, float x, float y, int iRow, short clusterState, bool sideC);
