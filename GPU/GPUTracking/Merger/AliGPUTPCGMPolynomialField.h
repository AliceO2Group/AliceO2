...
inline void AliGPUTPCGMPolynomialField::Set(float nominalBz, const float *Bx, const float *By, const float *Bz, const float *TrdBx, const float *TrdBy, const float *TrdBz)
{
...
GPUdi() void AliGPUTPCGMPolynomialField::GetPolynoms( float x, float y, float z, float f[fkM] )
{
	f[0]=1.f;
	f[1]=x;   f[2]=y;   f[3]=z;
