...
void GPUTPCDecompression::SetMaxData(const GPUTrackingInOutPointers& io)
{
  ...
  float clsRatio1 = (mInputGPU.nUnattachedClusters > 0 ? float(mInputGPU.nAttachedClusters) / float(mInputGPU.nUnattachedClusters) : 1.0f) * 1.5;
  ...
  mMaxNativeClustersPerBuffer += 1000;
}
