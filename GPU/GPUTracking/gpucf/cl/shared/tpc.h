...
#define TPC_PADS_PER_ROW_PADDED (TPC_PADS_PER_ROW+PADDING)
// Keep divisible by 8
#define TPC_NUM_OF_PADS (TPC_NUM_OF_ROWS * TPC_PADS_PER_ROW_PADDED + PADDING + 6)
#define TPC_MAX_TIME 12000
