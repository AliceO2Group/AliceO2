...
AddOptionRTC(searchWindowDZDR, float, 2.5, "", 0, "Use DZDR window for seeding instead of neighboursSearchArea")
...
AddOptionRTC(extraClusterErrorEdgeY2, float, 0.35, "", 0, "Additive extra cluster error for Y2 if edge flag set")
AddOptionRTC(extraClusterErrorEdgeZ2, float, 0.15, "", 0, "Additive extra cluster error for Z2 if edge flag set")
AddOptionRTC(extraClusterErrorSingleY2, float, 0.2, "", 0, "Additive extra cluster error for Y2 if edge single set")
AddOptionRTC(extraClusterErrorSingleZ2, float, 0.2, "", 0, "Additive extra cluster error for Z2 if edge single set")
AddOptionRTC(extraClusterErrorSplitPadSharedSingleY2, float, 0.03, "", 0, "Additive extra cluster error for Y2 if splitpad, shared, or single set")
AddOptionRTC(extraClusterErrorFactorSplitPadSharedSingleY2, float, 3.0, "", 0, "Multiplicative extra cluster error for Y2 if splitpad, shared, or single set")
AddOptionRTC(extraClusterErrorSplitTimeSharedSingleZ2, float, 0.03, "", 0, "Additive extra cluster error for Z2 if splittime, shared, or single set")
AddOptionRTC(extraClusterErrorFactorSplitTimeSharedSingleZ2, float, 3.0, "", 0, "Multiplicative extra cluster error for Z2 if splittime, shared, or single set")
AddOptionRTC(globalTrackingYRangeUpper, float, 0.85, "", 0, "Inner portion of y-range in slice that is not used in searching for global track candidates")
AddOptionRTC(globalTrackingYRangeLower, float, 0.85, "", 0, "Inner portion of y-range in slice that is not used in searching for global track candidates")
AddOptionRTC(trackFollowingYFactor, float, 4, "", 0, "Weight of y residual vs z residual in tracklet constructor")
AddOptionRTC(trackMergerFactor2YS, float, 1.5 * 1.5, "", 0, "factor2YS for track merging")
AddOptionRTC(trackMergerFactor2ZT, float, 1.5 * 1.5, "", 0, "factor2ZT for track merging")
AddOptionRTC(trackMergerFactor2K, float, 2.0 * 2.0, "", 0, "factor2K for track merging")
AddOptionRTC(trackMergerFactor2General, float, 3.5 * 3.5, "", 0, "General factor for track merging")
