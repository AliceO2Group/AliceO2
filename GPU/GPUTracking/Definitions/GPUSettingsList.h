...
AddOption(dEdxUseFullGainMap, bool, true, "", 0, "Enable using the full gain map for correcting the cluster charge during calculation of the dE/dx")
AddOption(gainCalibFile, std::string, "", "", 0, "File name of TPC pad gain calibration")
AddOption(gainCalibDisableCCDB, bool, true, "", 0, "Disabling loading the TPC pad gain calibration from the CCDB")
