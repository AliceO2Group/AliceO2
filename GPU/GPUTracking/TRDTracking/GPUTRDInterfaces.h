...
template <> class trackInterface<AliExternalTrackParam> : public AliExternalTrackParam
{
  ...
  public:
    ...
    trackInterface<AliExternalTrackParam>(const GPUTPCGMMergedTrack &trk) :
      AliExternalTrackParam()
    {
      Set( trk.GetParam().GetX(), trk.GetAlpha(), trk.GetParam().GetPar(), trk.GetParam().GetCov() );
    }
    trackInterface<AliExternalTrackParam>(const GPUTPCGMTrackParam::GPUTPCOuterParam &param) :
      AliExternalTrackParam()
    {
...
template <> class trackInterface<GPUTPCGMTrackParam> : public GPUTPCGMTrackParam
{
  public:
    GPUd() trackInterface<GPUTPCGMTrackParam>() : GPUTPCGMTrackParam(), mAlpha(0.f) {};
    GPUd() trackInterface<GPUTPCGMTrackParam>(const GPUTPCGMTrackParam &param) CON_DELETE;
    GPUd() trackInterface<GPUTPCGMTrackParam>(const GPUTPCGMMergedTrack &trk) :
      GPUTPCGMTrackParam(),
      mAlpha(trk.GetAlpha())
    {
    ...
    GPUd() trackInterface<GPUTPCGMTrackParam>(const GPUTPCGMTrackParam::GPUTPCOuterParam &param) :
      GPUTPCGMTrackParam(),
      mAlpha(param.fAlpha)
    {
      SetX(param.fX);
    ...
    GPUd() trackInterface<GPUTPCGMTrackParam>(const trackInterface<GPUTPCGMTrackParam> &param) :
      GPUTPCGMTrackParam(),
      mAlpha(param.mAlpha)
    {
      SetX(param.getX());
    ...
    trackInterface<GPUTPCGMTrackParam>(const AliHLTExternalTrackParam &param) :
      GPUTPCGMTrackParam(),
      mAlpha(param.fAlpha)
    {
      SetX(param.fX);
...
template <> class propagatorInterface<GPUTPCGMPropagator> : public GPUTPCGMPropagator
{
  public:
    ...
    GPUd() void setTrack(trackInterface<GPUTPCGMTrackParam> *trk) { SetTrack(trk, trk->getAlpha()); mTrack = trk;}
