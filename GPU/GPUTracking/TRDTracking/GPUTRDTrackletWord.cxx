...
GPUd() GPUTRDTrackletWord::GPUTRDTrackletWord(unsigned int trackletWord) :
  mId(-1),
  mHCId(-1),
...
GPUd() GPUTRDTrackletWord::GPUTRDTrackletWord(unsigned int trackletWord, int hcid, int id) :
  mId(id),
  mHCId(hcid),
  mTrackletWord(trackletWord)
{
...
GPUTRDTrackletWord::GPUTRDTrackletWord(const AliTRDtrackletWord &rhs) :
  mId(-1),
  mHCId(rhs.GetHCId()),
...
GPUTRDTrackletWord::GPUTRDTrackletWord(const AliTRDtrackletMCM &rhs) :
  mId(-1),
  mHCId(rhs.GetHCId()),
  mTrackletWord(rhs.GetTrackletWord())
{
