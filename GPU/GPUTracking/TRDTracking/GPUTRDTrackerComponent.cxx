// $Id: GPUTRDTrackerComponent.cxx 2016-05-22 16:08:40Z marten $
// **************************************************************************
...
GPUTRDTrackerComponent::GPUTRDTrackerComponent( const GPUTRDTrackerComponent& )
  :
  fTracker(0x0),
  fGeo(0x0),
  fTrackList(0x0),
...
const char* GPUTRDTrackerComponent::GetComponentID() {
  return "TRDTracker";
}
...
AliHLTComponentDataType GPUTRDTrackerComponent::GetOutputDataType() {
...
// #################################################################################
int GPUTRDTrackerComponent::DoEvent
(
