...
{
  GPUCA_OPENMP(parallel for if(!processors.trdTracker.GetRec().GetDeviceProcessingSettings().ompKernels) num_threads(processors.trdTracker.GetRec().GetDeviceProcessingSettings().nThreads))
