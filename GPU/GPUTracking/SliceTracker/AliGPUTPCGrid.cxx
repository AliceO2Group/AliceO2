...
void AliGPUTPCGrid::CreateEmpty()
{
...
GPUd() void AliGPUTPCGrid::Create(float yMin, float yMax, float zMin, float zMax, float sy, float sz)
{
	//* Create the grid
	fYMin = yMin;
	fZMin = zMin;
...
GPUd() int AliGPUTPCGrid::GetBin(float Y, float Z) const
{
	//* get the bin pointer
...
GPUd() int AliGPUTPCGrid::GetBinBounded(float Y, float Z) const
{
	//* get the bin pointer
	const int yBin = static_cast<int>((Y - fYMin) * fStepYInv);
	const int zBin = static_cast<int>((Z - fZMin) * fStepZInv);
...
GPUd() void AliGPUTPCGrid::GetBin(float Y, float Z, int *const bY, int *const bZ) const
{
	//* get the bin pointer
...
GPUd() void AliGPUTPCGrid::GetBinArea(float Y, float Z, float dy, float dz, int &bin, int &ny, int &nz) const
{
	Y -= fYMin;
