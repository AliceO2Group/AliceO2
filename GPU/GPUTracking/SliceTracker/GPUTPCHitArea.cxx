...
MEM_TEMPLATE() GPUd() void GPUTPCHitArea::Init(const MEM_TYPE(GPUTPCRow) & row, GPUglobalref() const MEM_GLOBAL(GPUTPCSliceData) & slice, float y, float z,
                                     float dy, float dz)
{
	//initialisation
...
MEM_TEMPLATE() GPUd() int GPUTPCHitArea::GetNext(GPUconstantref() const MEM_CONSTANT(GPUTPCTracker) & tracker, const MEM_TYPE(GPUTPCRow) & row,
