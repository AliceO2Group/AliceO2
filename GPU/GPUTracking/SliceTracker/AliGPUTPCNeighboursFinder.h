...
#if defined(GPUCA_GPUCODE)
		float2 fA[GPUCA_GPUCA_THREAD_COUNT_FINDER][ALIHLTTPCCANEIGHBOURS_FINDER_MAX_NNEIGHUP]; // temp memory
		calink fB[GPUCA_GPUCA_THREAD_COUNT_FINDER][ALIHLTTPCCANEIGHBOURS_FINDER_MAX_NNEIGHUP]; // temp memory
#else
