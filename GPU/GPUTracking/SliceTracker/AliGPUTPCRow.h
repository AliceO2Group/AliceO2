 ...
 * It is the internal class of the AliGPUTPCTracker algorithm.
 *
 */
MEM_CLASS_PRE()
class AliGPUTPCRow
{
	MEM_CLASS_PRE2()
	friend class AliGPUTPCSliceData;
  ...
  public:
	...
	GPUhd() MakeType(const AliGPUTPCGrid &) Grid() const { return fGrid; }
  ...
  private:
	...
	AliGPUTPCGrid fGrid; // grid of hits
	...
	// offset in AliGPUTPCSliceData::LinkUp/DownData/HitDataY/...
