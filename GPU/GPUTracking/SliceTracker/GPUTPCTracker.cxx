...
void GPUTPCTracker::RegisterMemoryAllocation()
{
  ...
  mRec->RegisterMemoryAllocation(this, &GPUTPCTracker::SetPointersDataInput, GPUMemoryResource::MEMORY_INPUT, "TPCSliceInput"); // TODO: Mark as MEMORY_STACK with 2 levels
