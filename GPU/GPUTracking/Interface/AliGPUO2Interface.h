...
#ifndef ALIGPUO2INTERFACE_H
#define ALIGPUO2INTERFACE_H
...
public:
	...
	int Initialize(const AliGPUO2InterfaceConfiguration& config, std::unique_ptr<ali_tpc_common::tpc_fast_transformation::TPCFastTransform>&& fastTrans);
