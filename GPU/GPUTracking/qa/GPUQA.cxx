...
inline int GPUQA::GetMCLabelCol(unsigned int i, unsigned int j) { return mMCEventOffset[mClNative->clustersMCTruth->getLabels(i)[j].getSourceID()] + mClNative->clustersMCTruth->getLabels(i)[j].getEventID(); }
