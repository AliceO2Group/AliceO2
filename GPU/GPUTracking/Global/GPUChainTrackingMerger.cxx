...
int GPUChainTracking::RunTPCTrackingMerger(bool synchronizeOutput)
{
  ...
  if (GetProcessingSettings().createO2Output) {
    ...
    // SynchronizeGPU(); // C: Does not work alone or in combination with A
