...
protected:
	...
	template <class T> void RunHelperThreads(T function, GPUReconstructionHelpers::helperDelegateBase* functionCls, int count);
...
template <class T> inline void GPUChain::RunHelperThreads(T function, GPUReconstructionHelpers::helperDelegateBase* functionCls, int count)
{
