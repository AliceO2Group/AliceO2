...
AliGPUTPCGMOfflineFitter::AliGPUTPCGMOfflineFitter()
  :fCAParam()
{
}
...
void AliGPUTPCGMOfflineFitter::Initialize( const AliGPUParam& hltParam, Long_t TimeStamp, bool isMC )
{
  //
...
void AliGPUTPCGMOfflineFitter::RefitTrack( AliGPUTPCGMMergedTrack &track, const AliGPUTPCGMPolynomialField* field,  AliGPUTPCGMMergedTrackHit* clusters )
{
...
int  AliGPUTPCGMOfflineFitter::CreateTPCclusterMI( const AliGPUTPCGMMergedTrackHit &h, AliTPCclusterMI &c)
{
  ...
  Int_t sector, row;
  AliGPUTPCGeometry::Slice2Sector( h.fSlice, h.fRow, sector, row);
...
bool AliGPUTPCGMOfflineFitter::FitOffline( const AliGPUTPCGMPolynomialField* field, AliGPUTPCGMMergedTrack &gmtrack,  AliGPUTPCGMMergedTrackHit* clusters, int &N )
{
  ...
  for( int ihit = ihitStart; ihit<maxN; ihit ++ ){
    ...
    if( iRow < AliGPUTPCGeometry::GetNRowLow() ) AliTPCtracker::fSectors = AliTPCtracker::fInnerSec;
