...
#define GPUCA_MAX_TRACKLETS          ((size_t)          64 * 1024)     // Max Number of Tracklets that can be processed by GPU Tracker, Should be divisible by 16 at least
#define GPUCA_MAX_TRACKS             ((size_t)          32 * 1024)     // Max number of Tracks that can be processd by GPU Tracker per sector, must be below 2^24 for track ID format!!!
#define GPUCA_MAX_ROWSTARTHITS       ((size_t)          32 * 1024)     // Maximum number of start hits per row
