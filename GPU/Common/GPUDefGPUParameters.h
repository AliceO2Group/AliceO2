...
#define GPUCA_ERROR_TRACK_OVERFLOW 4
#define GPUCA_ERROR_TRACK_HIT_OVERFLOW 5
#define GPUCA_ERROR_GLOBAL_TRACKING_TRACK_OVERFLOW 6
#define GPUCA_ERROR_GLOBAL_TRACKING_TRACK_HIT_OVERFLOW 7
#define GPUCA_ERROR_STRINGS {"GPUCA_ERROR_NONE", "GPUCA_ERROR_ROWSTARTHIT_OVERFLOW", "GPUCA_ERROR_STARTHIT_OVERFLOW", "GPUCA_ERROR_TRACKLET_OVERFLOW", "GPUCA_ERROR_TRACK_OVERFLOW", "GPUCA_ERROR_TRACK_HIT_OVERFLOW", "GPUCA_ERROR_GLOBAL_TRACKING_TRACK_OVERFLOW", "GPUCA_ERROR_GLOBAL_TRACKING_TRACK_HIT_OVERFLOW"}
