...
#include "ITS3Simulation/V11Geometry.h" // for V11Geometry
#include "ITS3Simulation/Detector.h"    // for Detector, Detector::Model
...
class V1Layer : public V11Geometry
{
 ...
 public:
  ...
  void setStaveModel(o2::its3::Detector::Model model)
  {
    mStaveModel = model;
  }
