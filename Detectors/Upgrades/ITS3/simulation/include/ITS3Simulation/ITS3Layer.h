...
class ITS3Layer : public TObject
{
 public:
  ...
  void setGapBetweenEmispheres(double gap) { mGapZ = gap; }
 ...
 private:
  ...
  double mGapZ{0.};                 //! gap between emispheres in z direction
  double mGapPhi{0.};               //! gap between emispheres in phi (distance in z direction)
