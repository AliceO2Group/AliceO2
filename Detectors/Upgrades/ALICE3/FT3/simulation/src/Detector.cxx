...
//_________________________________________________________________________________________________
void Detector::buildFT3SD()
{
  // Build FT3 detector according to the Scoping Document
  LOG(info) << "Building FT3 Detector: SD";
  ...
  std::vector<std::array<Float_t, 5>> layersConfig{
    ...
    {100., 5.0, 35., layersx2X0},
    {122., 5.0, 35., layersx2X0},
    {150., 5.0, 80.f, layersx2X0},
    {180., 5.0, 80.f, layersx2X0},
    {220., 5.0, 80.f, layersx2X0},
    {279., 5.0, 80.f, layersx2X0},
    {340., 5.0, 80.f, layersx2X0},
    {400., 5.0, 80.f, layersx2X0}};
