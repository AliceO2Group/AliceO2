...
TGeoVolumeAssembly* Detector::buildModuleCherenkov_v1()
{
  ...
  float x[N] = {7.5f, 7.5f, 6.4f, 3.2f, 0.f, -3.2f, -6.4f, -7.5f, -7.5f, -7.5f, -6.4f, -3.2f,
                0.f, 3.2f, 6.4f, 7.5f, 10.7f, 10.7f, 9.6f, 9.6f, 6.4f, 3.2f, 0.f, -3.2f,
                -6.4f, -9.6f, -9.6f, -10.7f, -10.7f, -10.7f, -9.6f, -9.6f, -6.4f, -3.2f, 0.f, 3.2f,
                6.4f, 9.6f, 9.6f, 10.7f, 13.9f, 13.9f, 12.8f, 12.8f, 9.6f, 6.4f, 3.2f, 0.f,
                -3.2f, -6.4f, -9.6f, -12.8f, -12.8f, -13.9f, -13.9f, -13.9f, -12.8f, -12.8f, -9.6f, -6.4f,
                -3.2f, 0.f, 3.2f, 6.4f, 9.6f, 12.8f, 12.8f, 13.9f};

  float y[N] = {0.f, 3.2f, 6.4f, 7.5f, 7.5f, 7.5f, 6.4f, 3.2f, 0.f, -3.2f, -6.4f, -7.5f,
                -7.5f, -7.5f, -6.4f, -3.2f, 0.f, 3.2f, 6.4f, 9.6f, 9.6f, 10.7f, 10.7f, 10.7f,
                9.6f, 9.6f, 6.4f, 3.2f, 0.f, -3.2f, -6.4f, -9.6f, -9.6f, -10.7f, -10.7f, -10.7f,
                -9.6f, -9.6f, -6.4f, -3.2f, 0.f, 3.2f, 6.4f, 9.6f, 12.8f, 12.8f, 13.9f, 13.9f,
                13.9f, 12.8f, 12.8f, 9.6f, 6.4f, 3.2f, 0.f, -3.2f, -6.4f, -9.6f, -12.8f, -12.8f,
                -13.9f, -13.9f, -13.9f, -12.8f, -12.8f, -9.6f, -6.4f, -3.2f};

  for (int i = 0; i < N; i++) {
    int cellId = mChannelCounter++;
    std::string nodeName = "fd3_node" + std::to_string(cellId);
    auto box = new TGeoBBox(rsizeq, rsizeq, dz / 2);
...
TGeoVolumeAssembly* Detector::buildModuleCherenkov_v2()
{
  ...
  float x[N] = {4.6f, 3.2f, 0.f, -3.2f, -4.6f, -3.2f, 0.f, 3.2f, 7.8f, 6.4f, 6.4f, 3.2f,
                0.f, -3.2f, -6.4f, -6.4f, -7.8f, -6.4f, -6.4f, -3.2f, 0.f, 3.2f, 6.4f, 6.4f,
                11.f, 9.6f, 9.6f, 9.6f, 6.4f, 3.2f, 0.f, -3.2f, -6.4f, -9.6f, -9.6f, -9.6f,
                -11.f, -9.6f, -9.6f, -9.6f, -6.4f, -3.2f, 0.f, 3.2f, 6.4f, 9.6f, 9.6f, 9.6f,
                14.2f, 12.8f, 12.8f, 6.4f, 3.2f, 0.f, -3.2f, -6.4f, -12.8f, -12.8f, -14.2f, -12.8f,
                -12.8f, -6.4f, -3.2f, 0.f, 3.2f, 6.4f, 12.8f, 12.8f};

  float y[N] = {0.f, 3.2f, 4.6f, 3.2f, 0.f, -3.2f, -4.6f, -3.2f, 0.f, 3.2f, 6.4f, 6.4f,
                7.8f, 6.4f, 6.4f, 3.2f, 0.f, -3.2f, -6.4f, -6.4f, -7.8f, -6.4f, -6.4f, -3.2f,
                0.f, 3.2f, 6.4f, 9.6f, 9.6f, 9.6f, 11.f, 9.6f, 9.6f, 9.6f, 6.4f, 3.2f,
                0.f, -3.2f, -6.4f, -9.6f, -9.6f, -9.6f, -11.f, -9.6f, -9.6f, -9.6f, -6.4f, -3.2f,
                0.f, 3.2f, 6.4f, 12.8f, 12.8f, 14.2f, 12.8f, 12.8f, 6.4f, 3.2f, 0.f, -3.2f,
                -6.4f, -12.8f, -12.8f, -14.2f, -12.8f, -12.8f, -6.4f, -3.2f};
