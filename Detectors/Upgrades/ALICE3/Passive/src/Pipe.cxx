...
void Alice3Pipe::ConstructGeometry()
{
  ...
  if (!mIsTRKActivated) {
    ...
    std::vector<std::array<float, 3>> layersQuotas = {std::array<float, 3>{0.5f, 30.f, 50.e-4}, // TODO: Set layers dynamically. {radius, zLen, thickness}
                                                      std::array<float, 3>{1.2f, 30.f, 50.e-4},
                                                      std::array<float, 3>{2.5f, 30.f, 50.e-4}};
