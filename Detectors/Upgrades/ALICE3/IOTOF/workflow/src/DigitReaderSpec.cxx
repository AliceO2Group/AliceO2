...
void TF3DigitReader::init(o2::framework::InitContext& ic)
{
  mFileName = ic.options().get<std::string>((mDetNameLC + "-digit-infile").c_str());
  connectTree(mFileName);
}

void TF3DigitReader::run(o2::framework::ProcessingContext& pc)
{
  ...
  mTree->GetEntry(ent);
  LOG(info) << mDetName << "TF3DigitReader pushes " << mDigROFRec.size() << " ROFRecords, "
...
void TF3DigitReader::connectTree(const std::string& filename)
{
