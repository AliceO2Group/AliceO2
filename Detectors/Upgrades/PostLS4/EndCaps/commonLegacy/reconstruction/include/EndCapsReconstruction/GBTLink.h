...
/// \file GBTLink.h
/// \brief Declarations of helper classes for the PostLS4 Endcaps raw data decoding

#ifndef _ALICEO2_ENDCAPS_GBTLINK_H_
#define _ALICEO2_ENDCAPS_GBTLINK_H_
...
#endif // _ALICEO2_ENDCAPS_GBTLINK_H_
