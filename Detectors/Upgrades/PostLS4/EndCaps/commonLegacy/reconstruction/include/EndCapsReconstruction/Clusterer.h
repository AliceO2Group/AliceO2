...
#ifndef ALICEO2_ENDCAPSLAYERS_CLUSTERER_H
#define ALICEO2_ENDCAPSLAYERS_CLUSTERER_H
...
class Clusterer
{
 ...
 private:
  ...
  const o2::endcaps::GeometryTGeo* mGeometry = nullptr; //! EC0 upgrade geometry
...
#endif /* ALICEO2_ENDCAPSLAYERS_CLUSTERER_H */
