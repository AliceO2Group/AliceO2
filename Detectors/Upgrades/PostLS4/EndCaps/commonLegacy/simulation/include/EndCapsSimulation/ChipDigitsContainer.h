...
#ifndef ALICEO2_ENDCAPS_CHIPDIGITSCONTAINER_
#define ALICEO2_ENDCAPS_CHIPDIGITSCONTAINER_

#include "SimulationDataFormat/MCCompLabel.h"
#include "EndCapsSimulation/PreDigit.h"
#include <map>
#include <vector>
...
class ChipDigitsContainer
{
 public:
  ...
  std::map<ULong64_t, PreDigit>& getPreDigits() { return mDigits; }
  ...
  void addNoise(UInt_t rofMin, UInt_t rofMax, const DigiParams* params);
...
inline PreDigit* ChipDigitsContainer::findDigit(ULong64_t key)
{
...
{
  mDigits.emplace(std::make_pair(key, PreDigit(roframe, row, col, charge, lbl)));
}
} // namespace endcaps
} // namespace o2

#endif /* defined(ALICEO2_ENDCAPS_CHIPCONTAINER_) */
