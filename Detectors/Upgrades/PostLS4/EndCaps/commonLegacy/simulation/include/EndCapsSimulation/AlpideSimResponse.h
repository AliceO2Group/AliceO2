...
/// \brief Definition of the EC0 Alpide simulated response parametrization

#ifndef ALICEO2_ENDCAPSLAYERSSMFT_ALPIDESIMRESPONSE_H
#define ALICEO2_ENDCAPSLAYERSSMFT_ALPIDESIMRESPONSE_H
