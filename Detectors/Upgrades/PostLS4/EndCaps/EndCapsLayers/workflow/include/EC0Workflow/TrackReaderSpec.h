...
#ifndef O2_EC0_TRACKREADER
#define O2_EC0_TRACKREADER
...
class TrackReader : public o2::framework::Task
{
 ...
 protected:
  ...
  o2::header::DataOrigin mOrigin = o2::header::gDataOriginEC0;
  ...
  std::string mROFBranchName = "EC0TracksROF";
  std::string mTrackBranchName = "EC0Track";
  std::string mClusIdxBranchName = "EC0TrackClusIdx";
  std::string mVertexBranchName = "Vertices";
  std::string mVertexROFBranchName = "VerticesROF";
  std::string mTrackMCTruthBranchName = "EC0TrackMCTruth";
};

/// create a processor spec
/// read EC0 track data from a root file
framework::DataProcessorSpec getEC0TrackReaderSpec(bool useMC = true);

} // namespace ecl
} // namespace o2

#endif /* O2_EC0_TRACKREADER */
