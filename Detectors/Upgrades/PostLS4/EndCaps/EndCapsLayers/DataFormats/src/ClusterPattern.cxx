...
//ClassImp(o2::endcaps::ClusterPattern);
...
ClusterPattern::ClusterPattern(int nRow, int nCol, const unsigned char patt[o2::itsmft::Cluster::kMaxPatternBytes])
{
...
{
  if (n < 0 || n > o2::itsmft::Cluster::kMaxPatternBytes + 1) {
...
void ClusterPattern::setPattern(int nRow, int nCol, const unsigned char patt[o2::itsmft::Cluster::kMaxPatternBytes])
{
...
void ClusterPattern::setPattern(const unsigned char patt[o2::itsmft::ClusterPattern::kExtendedPatternBytes])
{
...
int ClusterPattern::getCOG(int rowSpan, int colSpan, const unsigned char patt[o2::itsmft::Cluster::kMaxPatternBytes], float& xCOG, float& zCOG)
{
