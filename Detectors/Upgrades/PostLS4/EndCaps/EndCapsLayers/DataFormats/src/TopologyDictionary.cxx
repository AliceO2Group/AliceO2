...
Point3D<float> TopologyDictionary::getClusterCoordinates(const o2::itsmft::CompCluster& cl) const
{
  Point3D<float> locCl;
...
Point3D<float> TopologyDictionary::getClusterCoordinates(const o2::itsmft::CompCluster& cl, const ClusterPattern& patt)
{
  float xCOG = 0, zCOG = 0;
