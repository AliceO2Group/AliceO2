...
#ifndef O2_EC0_STANDALONE_DEBUGGER_H_
#define O2_EC0_STANDALONE_DEBUGGER_H_
...
{
 public:
  explicit StandaloneDebugger(const std::string debugTreeFileName = "dbg_EC0.root");
  ~StandaloneDebugger();
  ...
  void fillCombinatoricsTree(std::array<std::vector<Cluster>, constants::ecl::LayersNumberVertexer>&,
                             std::vector<Tracklet>,
                             std::vector<Tracklet>,
                             const ROframe*);
  void fillCombinatoricsMCTree(std::vector<Tracklet>, std::vector<Tracklet>);
  void fillTrackletSelectionTree(std::array<std::vector<Cluster>, constants::ecl::LayersNumberVertexer>&,
 ...
 private:
  std::string mDebugTreeFileName = "dbg_EC0.root"; // output filename
...
#endif /*O2_EC0_STANDALONE_DEBUGGER_H_*/
