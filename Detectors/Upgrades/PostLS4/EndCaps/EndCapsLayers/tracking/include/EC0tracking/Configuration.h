...
#ifndef TRACKINGEC0__INCLUDE_CONFIGURATION_H_
#define TRACKINGEC0__INCLUDE_CONFIGURATION_H_
...
struct TrackingParameters {
  ...
  float TrackletMaxDeltaZ[constants::ecl::TrackletsPerRoad] = {0.1f, 0.1f, 0.3f, 0.3f, 0.3f, 0.3f};
  /// Cell finding cuts
  float CellMaxDeltaTanLambda = 0.025f;
  float CellMaxDCA[constants::ecl::CellsPerRoad] = {0.05f, 0.04f, 0.05f, 0.2f, 0.4f};
  float CellMaxDeltaPhi = 0.14f;
  float CellMaxDeltaZ[constants::ecl::CellsPerRoad] = {0.2f, 0.4f, 0.5f, 0.6f, 3.0f};
  /// Neighbour finding cuts
  float NeighbourMaxDeltaCurvature[constants::ecl::CellsPerRoad - 1] = {0.008f, 0.0025f, 0.003f, 0.0035f};
  float NeighbourMaxDeltaN[constants::ecl::CellsPerRoad - 1] = {0.002f, 0.0090f, 0.002f, 0.005f};
};
...
struct MemoryParameters {
  ...
  float CellsMemoryCoefficients[constants::ecl::CellsPerRoad] = {2.3208e-08f, 2.104e-08f, 1.6432e-08f, 1.2412e-08f, 1.3543e-08f};
  float TrackletsMemoryCoefficients[constants::ecl::TrackletsPerRoad] = {0.0016353f, 0.0013627f, 0.000984f, 0.00078135f, 0.00057934f, 0.00052217f};
};

inline int TrackingParameters::CellMinimumLevel()
{
  return MinTrackLength - constants::ecl::ClustersPerCell + 1;
}
...
inline TrackingParameters& TrackingParameters::operator=(const TrackingParameters& t)
{
  ...
  for (int iT = 0; iT < constants::ecl::TrackletsPerRoad; ++iT)
  ...
  for (int iC = 0; iC < constants::ecl::CellsPerRoad; ++iC) {
    this->CellMaxDCA[iC] = t.CellMaxDCA[iC];
    this->CellMaxDeltaZ[iC] = t.CellMaxDeltaZ[iC];
  }
  /// Neighbour finding cuts
  for (int iC = 0; iC < constants::ecl::CellsPerRoad - 1; ++iC) {
...
struct VertexerStoreConfigurationGPU {
  ...
  // o2::ecl::GPU::Vector constructor requires signed size for initialisation
...
#endif /* TRACKINGEC0__INCLUDE_CONFIGURATION_H_ */
