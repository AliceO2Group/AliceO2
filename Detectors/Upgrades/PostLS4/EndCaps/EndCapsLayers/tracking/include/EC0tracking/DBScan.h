...
#ifndef O2_EC0_TRACKING_DBSCAN_H_
#define O2_EC0_TRACKING_DBSCAN_H_
...
{
  classifyVertices([nContributors](std::vector<o2::ecl::Edge>& edges) { return edges.size() == 0 ? 0 : edges.size() >= static_cast<size_t>(nContributors - 1) ? 2 : 1; },
