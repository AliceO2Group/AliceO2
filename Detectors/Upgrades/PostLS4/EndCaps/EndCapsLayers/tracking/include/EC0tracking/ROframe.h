...
#ifndef TRACKINGEC0__INCLUDE_ROFRAME_H_
#define TRACKINGEC0__INCLUDE_ROFRAME_H_
...
class ROframe final
{
 public:
  ...
  const std::array<std::vector<Cluster>, constants::ecl::LayersNumber>& getClusters() const;
  ...
  const std::array<std::vector<TrackingFrameInfo>, constants::ecl::LayersNumber>& getTrackingFrameInfo() const;
 ...
 private:
  ...
  std::array<std::vector<TrackingFrameInfo>, constants::ecl::LayersNumber> mTrackingFrameInfo;
  std::array<std::vector<MCCompLabel>, constants::ecl::LayersNumber> mClusterLabels;
  std::array<std::vector<int>, constants::ecl::LayersNumber> mClusterExternalIndices;
};
...
inline const std::array<std::vector<Cluster>, constants::ecl::LayersNumber>& ROframe::getClusters() const
{
  return mClusters;
}
...
inline const std::array<std::vector<TrackingFrameInfo>, constants::ecl::LayersNumber>& ROframe::getTrackingFrameInfo() const
{
...
{
  for (int iL = 0; iL < constants::ecl::LayersNumber; ++iL) {
    mClusters[iL].clear();
...
#endif /* TRACKINGEC0__INCLUDE_ROFRAME_H_ */
