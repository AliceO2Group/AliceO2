...
TrackerTraitsEC0* createTrackerTraitsEC0NV()
{
  return new TrackerTraitsEC0NV;
}

TrackerTraitsEC0NV::TrackerTraitsEC0NV()
{
...
void TrackerTraitsEC0NV::computeLayerTracklets()
{
...
void TrackerTraitsEC0NV::computeLayerCells()
{
