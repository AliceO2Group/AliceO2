...
#ifndef O2_EC0_TRACKING_DEVICE_STORE_VERTEXER_GPU_H_
#define O2_EC0_TRACKING_DEVICE_STORE_VERTEXER_GPU_H_
...
class DeviceStoreVertexerGPU final
{
 public:
  ...
  UniquePointer<DeviceStoreVertexerGPU> initialise(const std::array<std::vector<Cluster>, constants::ecl::LayersNumberVertexer>&,
  ...
  // RO APIs
  GPUd() const Array<Vector<Cluster>, constants::ecl::LayersNumberVertexer>& getClusters()
  {
    return mClusters;
  }
 ...
 private:
  ...
  Array<Vector<Cluster>, constants::ecl::LayersNumberVertexer> mClusters;
  ...
  Array<Vector<int>, constants::ecl::LayersNumberVertexer - 1> mNFoundDuplets;
...
#endif //O2_EC0_TRACKING_DEVICE_STORE_VERTEXER_GPU_H_
