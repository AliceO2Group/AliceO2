...
#ifndef O2_EC0_TRACKING_INCLUDE_VECTOR_HIP_H_
#define O2_EC0_TRACKING_INCLUDE_VECTOR_HIP_H_
...
#if defined(TRACKINGEC0__GPU_DEVICE)
    assert(0);
#else
    destroy();
#endif
...
#endif /* O2_EC0_TRACKING_INCLUDE_VECTOR_HIP_H_ */
