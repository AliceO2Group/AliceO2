...
#ifndef O2_EC0_TRACKING_INCLUDE_DEVICESTOREVERTEXER_HIP_H_
#define O2_EC0_TRACKING_INCLUDE_DEVICESTOREVERTEXER_HIP_H_
...
class DeviceStoreVertexerHIP final
{
 public:
  ...
  UniquePointer<DeviceStoreVertexerHIP> initialise(const std::array<std::vector<Cluster>, constants::ecl::LayersNumberVertexer>&,
                                                   const std::array<std::array<int, constants::index_table::ZBins * constants::index_table::PhiBins + 1>,
                                                                    constants::ecl::LayersNumberVertexer>&);

  // RO APIs
  GPUd() const ArrayHIP<VectorHIP<Cluster>, constants::ecl::LayersNumberVertexer>& getClusters()
  {
    return mClusters;
  }
 ...
 private:
  ...
  ArrayHIP<VectorHIP<Cluster>, constants::ecl::LayersNumberVertexer> mClusters;
  ...
  ArrayHIP<VectorHIP<int>, constants::ecl::LayersNumberVertexer - 1> mNFoundDuplets;
...
inline std::vector<int> DeviceStoreVertexerHIP::getNFoundTrackletsFromGPU(const Order order)
{
  ...
  sizes.resize(constants::ecl::LayersNumberVertexer);
...
#endif //O2_EC0_TRACKING_INCLUDE_DEVICESTOREVERTEXER_HIP_H_
