...
class HMPIDDCSDataProcessor : public o2::framework::Task
{
 public:
  ...
  void aliasString()
  {
    ...
    // ===| HV / SECTORS (V) |=========================================================	      
    int iSec = 6; 
    aliases.push_back(fmt::format("HMP_DET/HMP_MP[0..{}]/HMP_MP[0..{}]_PW/HMP_MP[0..{}]_SEC[0..{}]/HMP_MP[0..{}]_SEC[0..{}]_HV.actual.vMon",maxChambers,maxChambers,maxChambers,iSec,maxChambers,iSec));
