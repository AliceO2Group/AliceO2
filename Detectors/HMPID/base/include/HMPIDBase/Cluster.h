...
#ifndef DETECTORS_HMPID_BASE_INCLUDE_HMPIDBASE_CLUSTER_H_
#define DETECTORS_HMPID_BASE_INCLUDE_HMPIDBASE_CLUSTER_H_
...
#endif /* DETECTORS_HMPID_BASE_INCLUDE_HMPIDBASE_CLUSTER_H_ */
