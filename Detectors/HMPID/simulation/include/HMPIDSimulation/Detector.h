...
class Detector : public o2::base::DetImpl<Detector>
{
 public:
  ...
  std::vector<o2::hmpid::raw::HitType>* getHits(int iColl) const
  {
    if (iColl == 0) {
      return mHits;
    }
  ...
  o2::hmpid::raw::HitType* AddHit(float x, float y, float z, float time, float energy, Int_t trackId, Int_t detId);
 ...
 private:
  ...
  std::vector<o2::hmpid::raw::HitType>* mHits = nullptr; ///!< Collection of HMPID hits
  enum EMedia {
    kAir = 1,
    kRoha = 2,
    kSiO2 = 3,
