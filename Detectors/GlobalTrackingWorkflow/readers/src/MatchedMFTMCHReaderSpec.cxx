...
class MatchMFTMCHReader : public Task
{
 ...
 private:
  ...
  std::vector<o2::dataformats::MatchInfoMFTMCH> mTracks, *mTracksPtr = &mTracks;
...
void MatchMFTMCHReader::init(InitContext& ic)
{
  mFileName = o2::utils::Str::concat_string(o2::utils::Str::rectifyDirectory(ic.options().get<std::string>("input-dir")),
                                            ic.options().get<std::string>("matchmftmch-track-infile"));
...
void MatchMFTMCHReader::connectTree(const std::string& filename)
{
  ...
  mTree.reset((TTree*)mFile->Get("MFTMCHMatches"));
  assert(mTree);
...
DataProcessorSpec getMFTMCHMatchedReaderSpec(bool useMC)
{
  ...
  return DataProcessorSpec{
    ...
    Options{
      {"matchmftmch-track-infile", VariantType::String, "mftmchmatches.root", {"Name of the input file"}},
