...
#include "GlobalTrackingStudy/DumpTracks.h"
...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
  ...
  GID::mask_t allowedSourcesClus = GID::getSourcesMask("");
  ...
  specs.emplace_back(o2::trackstudy::getDumpTracksSpec(srcTrc, srcCls, useMC));
