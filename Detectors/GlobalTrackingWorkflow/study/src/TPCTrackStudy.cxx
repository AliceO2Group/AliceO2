...
void TPCTrackStudySpec::process(o2::globaltracking::RecoContainer& recoData)
{
  ...
  mTPCRefitter = std::make_unique<o2::gpu::GPUO2InterfaceRefit>(mTPCClusterIdxStruct, &mTPCCorrMapsLoader, prop->getNominalBz(), mTPCTrackClusIdx.data(), 0, mTPCRefitterShMap.data(), nullptr, nullptr, o2::base::Propagator::Instance());
