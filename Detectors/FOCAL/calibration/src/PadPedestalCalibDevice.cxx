...
PadPedestalCalibDevice::PadPedestalCalibDevice(bool updateCCDB, const std::string_view path) : mUpdateCCDB(updateCCDB), mPath(path) {}
...
void PadPedestalCalibDevice::sendData(o2::framework::DataAllocator& output)
{
  ...
  std::string filename = mPath + "/FOCALPadPedestals.root";
  TFile distwriter(filename.data(), "RECREATE");
  distwriter.cd();
...
o2::framework::DataProcessorSpec o2::focal::getPadPedestalCalibDevice(bool updateCCDB, const std::string_view path)
{
