...
class PadPedestalCalibDevice : public framework::Task
{
 public:
  ...
  PadPedestalCalibDevice(bool updateCCDB, const std::string_view path);
...
o2::framework::DataProcessorSpec getPadPedestalCalibDevice(bool updateCCDB, const std::string_view path);
