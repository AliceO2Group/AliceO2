...
#ifndef ALICEO2_FOCAL_PIXELMAPPERV1_H
#define ALICEO2_FOCAL_PIXELMAPPERV1_H
...
class PixelMapperV1
{
 public:
  ...
  {
   public:
    InvalidChipException(PixelMapperV1::ChipIdentifier& identifier) : mIdentifier(identifier), mMessage()
    {
    ...
    const PixelMapperV1::ChipIdentifier& getIdentifier() const { return mIdentifier; }
   ...
   private:
    PixelMapperV1::ChipIdentifier mIdentifier;
    std::string mMessage;
  };
  ...
  PixelMapperV1(MappingType_t mappingtype);
  ~PixelMapperV1() = default;
 ...
 private:
  ...
  ClassDefNV(PixelMapperV1, 1);
};

std::ostream& operator<<(std::ostream& stream, const PixelMapperV1::InvalidChipException& error);
std::ostream& operator<<(std::ostream& stream, const PixelMapperV1::UninitException& error);
std::ostream& operator<<(std::ostream& stream, const PixelMapperV1::MappingNotSetException& error);

} // namespace o2::focal

#endif // ALICEO2_FOCAL_PIXELMAPPERV1_H