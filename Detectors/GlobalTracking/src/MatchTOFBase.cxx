...
ClassImp(MatchTOFBase);

//______________________________________________
void MatchTOFBase::run()
{
...
//______________________________________________
void MatchTOFBase::setTOFClusterArray(const gsl::span<const Cluster>& clusterArray, const o2::dataformats::MCTruthContainer<o2::MCCompLabel>& toflab)
{
...
//______________________________________________
void MatchTOFBase::setTPCTrackArray(const gsl::span<const o2::tpc::TrackTPC>& trackArray, const gsl::span<const o2::MCCompLabel>& tpclab)
{
  mIsTPCused = true;
...
//______________________________________________
void MatchTOFBase::setITSTPCTrackArray(const gsl::span<const o2::dataformats::TrackTPCITS>& trackArray, const gsl::span<const o2::MCCompLabel>& tpclab)
{
  mIsITSTPCused = true;
...
//______________________________________________
void MatchTOFBase::printCandidatesTOF() const
{
  ///< print the candidates for the matching
}
//______________________________________________
bool MatchTOFBase::prepareTracks()
{
...
//______________________________________________
bool MatchTOFBase::prepareTPCTracks()
{
  ///< prepare the tracks that we want to match to TOF
...
//______________________________________________
bool MatchTOFBase::prepareTOFClusters()
{
  ///< prepare the tracks that we want to match to TOF
...
//______________________________________________
void MatchTOFBase::doMatching(int sec, trkType type)
{
...
//______________________________________________
void MatchTOFBase::doMatchingForTPC(int sec)
{
...
//______________________________________________
int MatchTOFBase::findFITIndex(int bc)
{
...
//______________________________________________
void MatchTOFBase::selectBestMatches()
{
  if (mSetHighPurity) {
    selectBestMatchesHP();
    return;
...
//______________________________________________
void MatchTOFBase::selectBestMatchesHP()
{
  ///< define the track-TOFcluster pair per sector
...
//______________________________________________
bool MatchTOFBase::propagateToRefX(o2::track::TrackParCov& trc, float xRef, float stepInCm, o2::track::TrackLTIntegral& intLT)
{
...
//______________________________________________
bool MatchTOFBase::propagateToRefXWithoutCov(o2::track::TrackParCov& trc, float xRef, float stepInCm, float bzField)
{
...
//______________________________________________
void MatchTOFBase::setDebugFlag(UInt_t flag, bool on)
{
...
//______________________________________________
void MatchTOFBase::updateTimeDependentParams()
{
...
bool MatchTOFBase::makeConstrainedTPCTrack(int matchedID, o2::dataformats::TrackTPCTOF& trConstr)
{
...
//_________________________________________________________
void MatchTOFBase::checkRefitter()
{
