...
int main(int argc, char** argv)
{
  ...
  try {
    ...
    // config with FDD defaults
    o2::fit::DigitToRawConfig::configureExecOptions(opt_general, "fdddigits.root", "alio2-cr1-flp201");
    // common part
  ...
  if (!cfg.mEnablePadding) {
    o2::fit::DigitToRawDevice<o2::fdd::RawWriterFDD>::digit2raw(cfg);
  } else {
    o2::fit::DigitToRawDevice<o2::fdd::RawWriterFDD_padded>::digit2raw(cfg);
  }
