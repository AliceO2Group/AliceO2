...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  ...
  wf.emplace_back(o2::fit::getFITIntegrateClusterSpec<o2::fdd::RecPoint>(disableWriter, minNChan, minAmpl));
  if (!disableWriter) {
    wf.emplace_back(o2::fit::getFITIntegrateClusterWriterSpec<o2::fdd::RecPoint>());
  }
  return wf;
}
