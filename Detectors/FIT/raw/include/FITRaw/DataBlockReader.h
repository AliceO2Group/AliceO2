...
template <class RawReader,class DigitBlockType, class... DataBlockTypes>
...
class RawReaderFT0 : public RawReaderBase<DigitBlockFT0, DataBlockPM, typename std::conditional<IsExtendedMode, DataBlockTCMext, DataBlockTCM>::type>
{
 public:
  ...
  ~RawReaderFT0() = default;
  //deserialize payload to raw data blocks and processs them to digits
  void process(int linkID, gsl::span<const uint8_t> payload)
  {
