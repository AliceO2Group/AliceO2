...
class ReadRaw
{
 ...
 public:
  ...
  void readData(const std::string fileRaw, const o2::fv0::LookUpTable& lut);
 ...
 private:
  ...
  o2::fv0::EventHeader mEventHeader;
  o2::fv0::TCMdata mTCMdata;
  ...
  long mSize;
  bool mIsPadded = true;
  std::map<o2::InteractionRecord, std::vector<o2::fv0::ChannelData>> mDigitAccum; // digit accumulator
