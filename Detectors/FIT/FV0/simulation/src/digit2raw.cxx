...
int main(int argc, char** argv)
{
  ...
  try {
    ...
    // config with FV0 defaults
    o2::fit::DigitToRawConfig::configureExecOptions(opt_general, "fv0digits.root", "alio2-cr1-flp180");
    // common part
  ...
  if (!cfg.mEnablePadding) {
    o2::fit::DigitToRawDevice<o2::fv0::RawWriterFV0>::digit2raw(cfg);
  } else {
    o2::fit::DigitToRawDevice<o2::fv0::RawWriterFV0_padded>::digit2raw(cfg);
  }
