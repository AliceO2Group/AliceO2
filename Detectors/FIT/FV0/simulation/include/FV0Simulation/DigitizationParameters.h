...
struct DigitizationParameters {
  ...
  static constexpr float CHARGE_PER_ADC = 0.6e-12;  // charge
  static constexpr float N_PHOTONS_PER_MEV = 10400; // average #photons generated by scintillator per 1 MeV of deposited energy

  //TODO: optimize random ring sizes to balance between sim quality and execution time
  static constexpr int PHE_RANDOM_RING_SIZE = 1e7; // size of random ring to be used inside photoelectron loop
