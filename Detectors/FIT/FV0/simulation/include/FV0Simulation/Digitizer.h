...
class Digitizer
{
 ...
 private:
  ...
  math_utils::RandomRing<float_v::size() * DigitizationParameters::HIT_RANDOM_RING_SIZE> mRndScintDelay;
  math_utils::RandomRing<float_v::size() * DigitizationParameters::PHE_RANDOM_RING_SIZE> mRndGainVar;
  math_utils::RandomRing<float_v::size() * DigitizationParameters::PHE_RANDOM_RING_SIZE> mRndSignalShape;
