...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
  ...
  WorkflowSpec specs;
  if (isExtendedMode) {
    specs.emplace_back(o2::fit::getFITDataReaderDPLSpec(RawReaderFV0ext{dataOrigin, dumpReader}, askSTFDist, isSubSampled, disableDplCcdbFetcher));
    if (!disableRootOut) {
    ...
    specs.emplace_back(o2::fit::getFITDataReaderDPLSpec(RawReaderFV0{dataOrigin, dumpReader}, askSTFDist, isSubSampled, disableDplCcdbFetcher));
    if (!disableRootOut) {
