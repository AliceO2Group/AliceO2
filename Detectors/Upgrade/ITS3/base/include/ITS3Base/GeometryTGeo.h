...
class GeometryTGeo : public o2::itsmft::GeometryTGeo
{
 public:
  ...
  static const char* composeSymNameITS() { return o2::detectors::DetID(o2::detectors::DetID::ITS3).getName(); }
  /// sym name of the layer
 ...
 private:
  static std::unique_ptr<o2::its3::GeometryTGeo> sInstance; ///< singletone instance
