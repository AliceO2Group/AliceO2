...
void V3Services::ibEndWheelSideA(const Int_t iLay, TGeoVolume* endWheel, const TGeoManager* mgr)
{
  ...
  TGeoMedium* medCarbon = mgr->GetMedium("ITS3_M55J6K$"); // TO BE CHECKED
  ...
  Int_t numberOfStaves = o2::its3::GeometryTGeo::Instance()->getNumberOfStaves(iLay);
...
TGeoVolume* V3Services::ibCyssCylinder(const TGeoManager* mgr)
{
  ...
  // We have all shapes: now create the real volumes
  TGeoMedium* medPrepreg = mgr->GetMedium("ITS3_F6151B05M$");
  TGeoMedium* medRohacell = mgr->GetMedium("ITS3_ROHACELL$");
...
TGeoVolume* V3Services::ibCyssFlangeSideA(const TGeoManager* mgr)
{
  ...
  // We have all shapes: now create the real volumes
  TGeoMedium* medAlu = mgr->GetMedium("ITS3_ALUMINUM$");
...
void V3Services::obEndWheelSideA(const Int_t iLay, TGeoVolume* mother, const TGeoManager* mgr)
{
  ...
  Int_t numberOfStaves = o2::its3::GeometryTGeo::Instance()->getNumberOfStaves(nLay);
