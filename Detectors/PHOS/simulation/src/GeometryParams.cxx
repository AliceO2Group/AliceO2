  ...
  mCradleWallThickness(0.)
{
  ...
  mAirGapLed = 1.5 - 2 * mPreampHalfSize[1] - 2 * mPinDiodeHalfSize[1] ; // Air gap before crystalls for LED system
  ...
  mAirCellHalfSize[1] = (mAirGapLed + 2*mPreampHalfSize[1] + 
                       2*mPinDiodeHalfSize[1] + 2*mWrappedHalfSize[1])/2 ;  //in strip
...
//			       fNCellsZInStrip * (2*fTyvecThickness + 2*fCrystalHalfSize[2]) )/2;
  ...
  mIPtoOuterCoverDistance = mIPtoCrystalSurface - mAirGapLed - mInnerThermoWidthY - mAirGapWidthY - 
                            mCoolerWidthY - mOuterThermoWidthY - mAlCoverThickness ; 
  ...
  mOuterThermoWidthXLow = mOuterThermoWidthXUp + 
                          2 * (2* mCoolerHalfSize[1] + mOuterThermoWidthY) * tanA  
                          - mAlCoverThickness ; 
  ...
  mWarmAlCoverWidthZ = mAirSpaceFeeZ + mWarmBottomThickness + mWarmUpperThickness +  
                       mTSupport1Thickness + mTSupport2Thickness ;
  ...
  //cables
  mTCables1HalfSize[0] = (2*mTSupport1HalfSize[0]*mNTSupports + (mNTSupports-1)* mTSupportDist) / 2 ; //Across beam
