...
/// @brief Conversion from CTF data -> AO2D standalone for PHOS (does not require other detectors like AODProducerWorklfow)
...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  ...
  wf.emplace_back(o2::phos::getPHOSStandaloneAODProducerSpec());
  return wf;
}
