...
class AliAlgVol : public TNamed
{
 public:
  ...
  //
  AliAlgVol* getParent() const { return mParent; }
  ...
  AliAlgVol* getChild(int i) const { return mChildren ? (AliAlgVol*)mChildren->UncheckedAt(i) : 0; }
 ...
 protected:
  ...
  //
  AliAlgVol* mParent;   // parent volume
