                          ...
                          bool verbose, bool loc, const char* outName)
{
  ...
  ResidualsControllerFast* rLG = store ? new ResidualsControllerFast() : 0;
  ResidualsControllerFast* rL = store && loc ? new ResidualsControllerFast() : 0;
  TTree *trLG = 0, *trL = 0;
  TFile* outFile = 0;
  if (store) {
