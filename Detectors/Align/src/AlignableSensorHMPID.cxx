...
void AlignableSensorHMPID::setTrackingFrame()
{
...
//____________________________________________
AlignmentPoint* AlignableSensorHMPID::TrackPoint2AlgPoint(int pntId, const AliTrackPointArray* trpArr, const AliESDtrack*)
{
