...
void AlignableSensorTPC::setTrackingFrame()
{
...
//____________________________________________
AlignmentPoint* AlignableSensorTPC::TrackPoint2AlgPoint(int pntId, const AliTrackPointArray* trpArr, const AliESDtrack*)
{
