...
static constexpr double sRPCShortCenterPos = 155.;    ///< Position of the short RPC in the right side of the first chamber
static constexpr double sRPCShortHalfLength = 102.;   ///< Half length of the short RPC in the first chamber
static constexpr double sRPCZShift = 3.6;             ///< Default shift of the RPC z position with respect to the average chamber position
static constexpr double sStripUnitPitchSize = 1.0625; ///< Unit pitch size of the strip in the first chamber

static constexpr std::array<const double, 4> sScaleFactors{{1., 1.01060, 1.06236, 1.07296}};         ///< Array of scale factors for projective geometry
static constexpr std::array<const double, 4> sDefaultChamberZ{{-1603.5, -1620.5, -1703.5, -1720.5}}; ///< Array of default z position of the chamber
...
inline double getLocalBoardHeight(int chamber) { return sLocalBoardHeight * sScaleFactors[chamber]; }

/// Returns the height of the local board in the chamber
/// @param chamber The chamber ID (0-3)
inline double getLocalBoardWidth(int chamber) { return sLocalBoardWidth * sScaleFactors[chamber]; }
...
/// @param chamber The chamber ID (0-3)
inline double getRPCHalfHeight(int chamber) { return 2. * sLocalBoardHeight * sScaleFactors[chamber]; }

/// Returns the unit strip pitch size in the chamber
/// @param chamber The chamber ID (0-3)
inline double getStripUnitPitchSize(int chamber) { return sStripUnitPitchSize * sScaleFactors[chamber]; }
