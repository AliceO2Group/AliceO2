...
/// \file TimeClusterFinderSpecV2.h
/// \brief Definition of a data processor to run the time clusterizer
///
/// \author Andrea Ferrero, CEA

#ifndef O2_MCH_TIMECLUSTERFINDERSPECV2_H_
#define O2_MCH_TIMECLUSTERFINDERSPECV2_H_
...
o2::framework::DataProcessorSpec
  getTimeClusterFinderSpecV2(const char* specName = "mch-time-cluster-finder-new",
...
#endif // O2_MCH_TIMECLUSTERFINDERSPECV2_H_
