...
CathodeSegmentation* createSegType6(bool isBendingPlane)
{
  if (isBendingPlane) {
    return new CathodeSegmentation{
      ...
      true,
      /* PG */
      { { 4, 2, 0, 0, -20 },    { 5, 8, 0, 5, -20 },    { 6, 4, 0, 15, -20 },
        { 7, 9, 0, 20, -20 },   { 8, 3, 0, 30, -20 },   { 12, 2, 0, -40, -20 },
        { 13, 8, 0, -35, -20 }, { 14, 4, 0, -25, -20 }, { 15, 9, 0, -20, -20 },
        { 16, 3, 0, -10, -20 }, { 101, 1, 0, 30, 0 },   { 102, 7, 0, 20, 0 },
        { 103, 5, 0, 15, 4 },   { 104, 6, 0, 5, 0 },    { 105, 0, 0, 0, 0 },
        { 110, 1, 0, -10, 0 },  { 111, 7, 0, -20, 0 },  { 112, 5, 0, -25, 4 },
        { 113, 6, 0, -35, 0 },  { 114, 0, 0, -40, 0 } },
      /* PGT */
