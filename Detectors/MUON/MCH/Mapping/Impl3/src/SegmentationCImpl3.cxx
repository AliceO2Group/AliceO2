...
MCHMAPPINGIMPL3_EXPORT MchSegmentationHandle mchSegmentationConstruct(int detElemId, bool isBendingPlane)
{
...
void mchSegmentationDestruct(MchSegmentationHandle sh) { delete sh; }
