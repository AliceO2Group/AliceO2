...
/// \brief Implementation of the MCH digitizer task

#include "MCHSimulation/DigitizerTask.h"
#include "MathUtils/Utils.h"

#include "FairLogger.h"      // for LOG
#include "FairRootManager.h" // for FairRootManager

ClassImp(o2::mch::DigitizerTask);

using namespace o2::mch;

DigitizerTask::DigitizerTask() : FairTask("MCHDigitizerTask"), mDigitizer() {}
...
InitStatus DigitizerTask::Init()
{
  ...
  mHitsArray = mgr->InitObjectAs<const std::vector<o2::mch::HitType>*>("MCHHit");//TODO check if existing
  if (!mHitsArray) {
    LOG(ERROR) << "MCH hits not registered in the FairRootManager. Exiting ..." << FairLogger::endl;
    return kERROR;
  }

  // Register output container
  mgr->RegisterAny("MCHDigit", mDigitsArray, kTRUE);

  // Register MC Truth container
  mMCTruthArray = new typename std::remove_pointer<decltype(mMCTruthArray)>::type;
  mgr->RegisterAny("MCHDigitMCTruth", mMCTruthArray, kTRUE);
