...
class MCHDigitizer
{
 ...
 private:  
  ...
  std::vector<mapping::Segmentation> mSegbend;//(156, mapping::Segmentation(101,true)); //, mapping::Segmentation (1,true) );//Segmentation has no default constructor...
    //  std::vector<mapping::Segmentation> mSegnon; //(156, mapping::Segmentation(1,false)); // (mNdE, mapping::Segmentation(1,true) ); //, mapping::Segmentation (1,false) );  //  mapping::Segmentation mSegbend = mapping::Segmentation(1,true);
