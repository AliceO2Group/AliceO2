...
/// \brief Definition of the MCH digitizer task

#ifndef ALICEO2_MCH_DIGITIZERTASK_H
#define ALICEO2_MCH_DIGITIZERTASK_H

#include "FairTask.h" // for FairTask, InitStatus
#include "Rtypes.h"   // for DigitizerTask::Class, ClassDef, etc

#include "MCHBase/DigitBlock.h"
#include "MCHSimulation/Detector.h" // for HitType
...
{
  using Digitizer = o2::mch::Digitizer;
 ...
 private:
  ...
  const std::vector<o2::mch::HitType>* mHitsArray = nullptr; ///< Array of MC hits
  std::vector<o2::mch::Digit>* mDigitsArray = nullptr;       ///< Array of digits
...
#endif /* ALICEO2_MCH_DIGITIZERTASK_H */
