...
/// \file Clusterizer.h
/// \brief Implementation of the cluster finder (ITS)
...
Float_t Clusterizer::mPitchX=0.002;
Float_t Clusterizer::mPitchZ=0.002;
Float_t Clusterizer::mX0=0.;
Float_t Clusterizer::mZ0=0.;
...
//_____________________________________________________________________________
void Clusterizer::process(PixelReader &reader, TClonesArray &clusters, GeometryTGeo* geo)
{
...
//_____________________________________________________________________________
void Clusterizer::initChip(UShort_t chipID, UShort_t row, UShort_t col, Int_t label)
{
...
//_____________________________________________________________________________
void Clusterizer::updateChip(UShort_t chipID, UShort_t row, UShort_t col, Int_t label)
{
...
//_____________________________________________________________________________
void Clusterizer::finishChip(TClonesArray &clusters)
{
  ...
  for (Int_t i1=0; i1<mPreClusterHeads.size(); ++i1) {
    ...
    c->transformITStoMFT(mGeometry->getMatrixSensor(mChipID),mGeometry->getMatrixSensorToITS(mChipID));
  }
