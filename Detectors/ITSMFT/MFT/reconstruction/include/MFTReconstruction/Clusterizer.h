...
#ifndef ALICEO2_MFT_CLUSTERIZER_H
#define ALICEO2_MFT_CLUSTERIZER_H
...
namespace o2 
{
  namespace MFT 
  {
	...
	mPitchX=px; mPitchZ=pz; mX0=x0; mZ0=z0;
      ...
      void process(PixelReader &r, TClonesArray &clusters, GeometryTGeo* geo);
    ...
    private:
      ...
      GeometryTGeo* mGeometry;         ///< Pointer to the MFT geometry helper
