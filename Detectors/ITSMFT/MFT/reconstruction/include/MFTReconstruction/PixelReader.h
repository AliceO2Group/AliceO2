...
/// \file PixelReader.h
/// \brief Definition of the MFT pixel reader (ITS)

#ifndef ALICEO2_MFT_PIXELREADER_H
#define ALICEO2_MFT_PIXELREADER_H
...
{
/// \class PixelReader
/// \brief PixelReader class for the MFT (ITS)
///
class PixelReader {
...
/// \brief DigitPixelReader class for the MFT. Feeds the MC digits to the Cluster Finder
///
...
/// \brief RawPixelReader class for the MFT. Feeds raw data to the Cluster Finder
///
