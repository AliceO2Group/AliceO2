...
// or submit itself to any jurisdiction.
 ...
 #include "MFTConditions/DCSNamer.h"
#include <gsl/span>
#include <iostream>
...
#include <vector>
 ...
 namespace
 {
   ...
   std::array<o2::ccdb::CcdbObjectInfo, 2> info{createDefaultInfo("MFT/HV"), createDefaultInfo("MFT/LV")};
   ...
   o2::framework::AlgorithmSpec::ProcessCallback createProcessFunction(o2::framework::InitContext& ic)
   {
     ...
     std::array<std::vector<std::string>, 2> aliases = {
       o2::mft::dcs::aliases({o2::mft::dcs::MeasurementType::HV_V,
	     o2::mft::dcs::MeasurementType::HV_I}),
       o2::mft::dcs::aliases({o2::mft::dcs::MeasurementType::LV_V_FEE_ANALOG,
	     o2::mft::dcs::MeasurementType::LV_V_FEE_DIGITAL,
	     o2::mft::dcs::MeasurementType::LV_V_SOLAR})};
...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
  ...
  dcsProcessor.name = "mft-dcs-processor";
  dcsProcessor.inputs = o2::framework::Inputs{{"input", "DCS", "MFTDATAPOINTS"}};
