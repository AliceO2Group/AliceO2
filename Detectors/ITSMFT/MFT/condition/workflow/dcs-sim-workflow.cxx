...
o2::framework::WorkflowSpec defineDataProcessing(o2::framework::ConfigContext const& configcontext)
{
  ...
  for (auto a : o2::mft::dcs::aliases({o2::mft::dcs::MeasurementType::HV_V})) {
    dphints.emplace_back(o2::dcs::test::DataPointHint<double>{a, 1630, 1670});
  }

  for (auto a : o2::mft::dcs::aliases({o2::mft::dcs::MeasurementType::HV_I})) {
    dphints.emplace_back(o2::dcs::test::DataPointHint<double>{a, 0.1, 10});
  }

  for (auto a : o2::mft::dcs::aliases({o2::mft::dcs::MeasurementType::LV_V_FEE_DIGITAL})) {
    dphints.emplace_back(o2::dcs::test::DataPointHint<double>{a, 1.15, 1.25});
  }

  for (auto a : o2::mft::dcs::aliases({o2::mft::dcs::MeasurementType::LV_V_FEE_ANALOG})) {
    dphints.emplace_back(o2::dcs::test::DataPointHint<double>{a, 1.15, 1.25});
  }

  for (auto a : o2::mft::dcs::aliases({o2::mft::dcs::MeasurementType::LV_V_SOLAR})) {
