...
TGeoVolumeAssembly* PowerSupplyUnit::create()
{
  ...
  auto* mPowerSupplyUnit = new TGeoVolumeAssembly();
  ...
  TGeoTubeSeg* middleTubeSeg1 = new TGeoTubeSeg("middleTubeSeg1", middle_board_min_radius1, middle_board_max_radius1, middle_board_thickness / 2, 180, 0);
  TGeoBBox* middleBox_sub1 = new TGeoBBox("middleBox_sub1", middleBox_sub_width1 / 2, middleBox_sub_height1 / 2, middle_board_thickness);
  TGeoBBox* middleBox_sub2 = new TGeoBBox("middleBox_sub2", middleBox_sub_width2 / 2, middleBox_sub_height2 / 2, middle_board_thickness);
  ...
  TGeoBBox* middleBox_edge1 = new TGeoBBox("middleBox_edge1", middleBox_edge_width1 / 2, middleBox_edge_height1 / 2, middle_board_thickness / 2);
  TGeoBBox* middleBox_edge_sub1 = new TGeoBBox("middleBox_edge_sub1", middleBox_edge_sub_width1 / 2, middleBox_edge_sub_height1 / 2, middle_board_thickness);
  TGeoBBox* middleBox_edge_sub2 = new TGeoBBox("middleBox_edge_sub2", middleBox_edge_sub_width2 / 2, middleBox_edge_sub_height2 / 2, middle_board_thickness);
  ...
  TGeoTubeSeg* middleBox_side_lack_right1 = new TGeoTubeSeg("middleBox_side_lack_right1", middleBox_side_lack_radius1, middle_board_max_radius1, middle_board_thickness, middleBox_side_lack_position_angle_min_right1, middleBox_side_lack_position_angle_max_right1);
  ...
  TGeoTubeSeg* middleBox_side_lack_left1 = new TGeoTubeSeg("middleBox_side_lack_left1", middleBox_side_lack_radius1, middle_board_max_radius1, middle_board_thickness, middleBox_side_lack_position_angle_min_left1, middleBox_side_lack_position_angle_max_left1);

  TGeoCompositeShape* middle_board_shape = new TGeoCompositeShape("middle_board_shape",
                                                                  "middleTubeSeg1"
  ...
  auto* middleCenterWaterPipeTorus_sub1 = new TGeoTorus("middleCenterWaterPipeTorus_sub1", center_pipe_sub_torus_radius1, pipe_sub_radius1, pipe_sub_radius1, 0, center_pipe_sub_torus_angle1);
  ...
  auto* middleSideWaterPipeTorus_sub1 = new TGeoTorus("middleSideWaterPipeTorus_sub1", side_pipe_sub_torus_radius1, pipe_sub_radius1, pipe_sub_radius1, 0, side_pipe_sub_torus_angle1);
  ...
  TGeoCompositeShape* rotated_middleSideWaterPipeTorus_sub_right1 = new TGeoCompositeShape("rotated_middleSideWaterPipeTorus_sub_right1",
                                                                                           "dummy + middleSideWaterPipeTorus_sub1:rmiddleSideWaterPipeTorus_sub_right1");
  TGeoCompositeShape* rotated_middleSideWaterPipeTorus_sub_left1 = new TGeoCompositeShape("rotated_middleSideWaterPipeTorus_sub_left1",
  ...
  TGeoTube* middleSideWaterPipeTube_sub1 = new TGeoTube("middleSideWaterPipeTube_sub1", 0, pipe_sub_radius1, side_pipe_sub_tube_length1 / 2);
  ...
  TGeoCompositeShape* rotated_middleSideWaterPipeTube_sub1 = new TGeoCompositeShape("rotated_middleSideWaterPipeTube_sub1", "dummy+middleSideWaterPipeTube_sub1:rmiddleSideWaterPipeTube_sub1");
  ...
  TGeoCompositeShape* middleWaterPipeTorus_sub_shape = new TGeoCompositeShape("middleWaterPipeTorus_sub_shape",
  ...
  mHalfPSU->AddNode(middle_peek_board, 0, NULL);
  ...
  auto* middleCenterWaterPipeTorus1 = new TGeoTorus("middleCenterWaterPipeTorus1", center_pipe_torus_radius1, pipe_min_radius1, pipe_max_radius1, 0, center_pipe_torus_angle1);
  ...
  auto* middleSideWaterPipeTorus1 = new TGeoTorus("middleSideWaterPipeTorus1", side_pipe_torus_radius1, pipe_min_radius1, pipe_max_radius1, 0, side_pipe_torus_angle1);
  ...
  TGeoCompositeShape* rotated_middleSideWaterPipeTorus_right1 = new TGeoCompositeShape("rotated_middleSideWaterPipeTorus_right1",
                                                                                       "dummy + middleSideWaterPipeTorus1:rmiddleSideWaterPipeTorus_right1");
  TGeoCompositeShape* rotated_middleSideWaterPipeTorus_left1 = new TGeoCompositeShape("rotated_middleSideWaterPipeTorus_left1",
  ...
  TGeoTube* middleSideWaterPipeTube1 = new TGeoTube("middleSideWaterPipeTube1", pipe_min_radius1, pipe_max_radius1, side_pipe_tube_length1 / 2);
  ...
  TGeoCompositeShape* rotated_middleSideWaterPipeTube1 = new TGeoCompositeShape("rotated_middleSideWaterPipeTube1", "dummy+middleSideWaterPipeTube1:rmiddleSideWaterPipeTube1");
  ...
  mHalfPSU->AddNode(water_pipe, 1, NULL);

  ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  //water in the pipe part
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////

  auto* middleCenterWaterTorus1 = new TGeoTorus("middleCenterWaterTorus1", center_pipe_torus_radius1, 0, pipe_min_radius1, 0, center_pipe_torus_angle1);
  ...
  auto* middleSideWaterTorus1 = new TGeoTorus("middleSideWaterTorus1", side_pipe_torus_radius1, 0, pipe_min_radius1, 0, side_pipe_torus_angle1);
  ...
  TGeoCompositeShape* rotated_middleSideWaterTorus_right1 = new TGeoCompositeShape("rotated_middleSideWaterTorus_right1", "dummy + middleSideWaterTorus1:rmiddleSideWaterTorus_right1");
  TGeoCompositeShape* rotated_middleSideWaterTorus_left1 = new TGeoCompositeShape("rotated_middleSideWaterTorus_left1", "dummy + middleSideWaterTorus1:rmiddleSideWaterTorus_left1");
  ...
  TGeoTube* middleSideWaterTube1 = new TGeoTube("middleSideWaterTube1", 0, pipe_min_radius1, side_pipe_tube_length1 / 2);

  auto* rmiddleSideWaterTube1 = new TGeoRotation("rmiddleSideWaterTube1", 90, 90, 0);
  rmiddleSideWaterTube1->RegisterYourself();

  TGeoCompositeShape* rotated_middleSideWaterTube1 = new TGeoCompositeShape("rotated_middleSideWaterTube1", "dummy+middleSideWaterTube1:rmiddleSideWaterTube1");
  ...
  TGeoTubeSeg* surfaceTubeSeg1 = new TGeoTubeSeg("surfaceTubeSeg1", surface_board_min_radius1, surface_board_max_radius1, surface_board_thickness / 2, 180, 0);
  TGeoBBox* surfaceBox_sub1 = new TGeoBBox("surfaceBox_sub1", surfaceBox_sub_width1 / 2, surfaceBox_sub_height1 / 2, surface_board_thickness);
  TGeoBBox* surfaceBox_sub2 = new TGeoBBox("surfaceBox_sub2", surfaceBox_sub_width2 / 2, surfaceBox_sub_height2 / 2, surface_board_thickness);
  ...
  TGeoBBox* surfaceBox_edge1 = new TGeoBBox("surfaceBox_edge1", surfaceBox_edge_width1 / 2, surfaceBox_edge_height1 / 2, surface_board_thickness / 2);
  TGeoBBox* surfaceBox_sub_edge1 = new TGeoBBox("surfaceBox_sub_edge1", surfaceBox_edge_sub_width1 / 2, surfaceBox_edge_sub_height1 / 2, surface_board_thickness);
  ...
  auto* surfaceCenterTubeSeg_sub1 = new TGeoTubeSeg("surfaceCenterTubeSeg_sub1", surfaceBox_center_sub_min_radius1, surfaceBox_center_sub_max_radius1, middle_board_thickness,
  ...
  TGeoBBox* surfaceBox_square_sub2 = new TGeoBBox("surfaceBox_square_sub2", surfaceBox_edge_sub_width2 / 2, surfaceBox_edge_sub_height2 / 2, surface_board_thickness);
  ...
  TGeoCompositeShape* surface_board_shape = new TGeoCompositeShape("surface_board_shape",
  ...
  mHalfPSU->AddNode(surface_board, 1, NULL);
  ...
  TGeoBBox* DCDC_main_shape1 = new TGeoBBox("DCDC_main_shape1", DCDC_main_width1 / 2, DCDC_main_height1 / 2, DCDC_main_thickness1 / 2);

  Double_t DCDC_width2 = 1.694;
  Double_t DCDC_height2 = 4.348;
  Double_t DCDC_thickness2 = 0.04;

  TGeoBBox* DCDC_shape2 = new TGeoBBox("DCDC_shape2", DCDC_width2 / 2, DCDC_height2 / 2, DCDC_thickness2 / 2);
  ...
  TGeoBBox* DCDC_sub_shape1 = new TGeoBBox("DCDC_sub_shape1", DCDC_sub_width1 / 2, DCDC_sub_height1 / 2, DCDC_sub_thickness1 / 2);
  ...
  TGeoCompositeShape* DCDC_shape1 = new TGeoCompositeShape("DCDC_shape1", "DCDC_main_shape1 - DCDC_sub_shape1:tDCDC_sub_shape1");
  ...
  TGeoCompositeShape* all_DCDC_shape1 = new TGeoCompositeShape("all_DCDC_shape", string_all_DCDC_shape1);

  TGeoRotation* rall_DCDC_shape1 = new TGeoRotation("rall_DCDC_shape1", 0, 180, 180);
  rall_DCDC_shape1->RegisterYourself();

  TGeoCompositeShape* all_DCDC_shape1_opposit = new TGeoCompositeShape("all_DCDC_shape_opposit", "dummy+all_DCDC_shape:rall_DCDC_shape1");

  TGeoCompositeShape* all_DCDC_base_shape = new TGeoCompositeShape("all_DCDC_base_shape", string_all_DCDC_shape2);
  ...
  TGeoCompositeShape* two_side_all_DCDC_shape = new TGeoCompositeShape("two_side_all_DCDC_shape", "all_DCDC_shape_opposit:tall_DCDC_shape_shape1 + all_DCDC_shape:tall_DCDC_shape_shape2");
  ...
  mHalfPSU->AddNode(DCDC1, 1, NULL);
  mHalfPSU->AddNode(DCDC2, 1, NULL);
  ...
  TGeoTorus* DCDC_coil_main_shape = new TGeoTorus("DCDC_coil_main_shape", DCDC_coil_radius1, 0, DCDC_coil_max_radius1, 0, 360);
  ...
  TGeoCompositeShape* DCDC_coil_straight_shape1 = new TGeoCompositeShape("DCDC_coil_straight_shape1",
  ...
  TGeoCompositeShape* DCDC_coil_torus_shape1 = new TGeoCompositeShape("DCDC_coil_torus_shape1",
  ...
  */
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //
  TGeoTorus* DCDC_rough_coil_torus_shape = new TGeoTorus("DCDC_rough_coil_torus_shape", DCDC_coil_torus_part_radius, DCDC_coil_radius1 - DCDC_coil_max_radius1,
                                                         DCDC_coil_radius1 + DCDC_coil_max_radius1, 0, 180);
  TGeoTube* DCDC_rough_coil_straight_shape = new TGeoTube("DCDC_rough_coil_straight_shape", DCDC_coil_radius1 - DCDC_coil_max_radius1, DCDC_coil_radius1 + DCDC_coil_max_radius1,
  ...
  TGeoCompositeShape* rotated_DCDC_rough_coil_torus_shape1 = new TGeoCompositeShape("rotated_DCDC_rough_coil_torus_shape1", "dummy+DCDC_rough_coil_torus_shape:rDCDC_rough_coil_torus_shape1");
  TGeoCompositeShape* rotated_DCDC_rough_coil_torus_shape2 = new TGeoCompositeShape("rotated_DCDC_rough_coil_torus_shape2", "dummy+DCDC_rough_coil_torus_shape:rDCDC_rough_coil_torus_shape2");
  ...
  TGeoCompositeShape* DCDC_rough_coil_shape1 = new TGeoCompositeShape("DCDC_coil_shape1",
  ...
  TGeoCompositeShape* rotated_DCDC_side_coil_shape = new TGeoCompositeShape("rotated_DCDC_side_coil_shape", "dummy+DCDC_coil_shape1:rDCDC_side_coil_shape1");
  ...
  TGeoCompositeShape* all_DCDC_coil_shape1 = new TGeoCompositeShape("all_DCDC_coil_shape1", string_all_DCDC_coil_shape1);
  ...
  mHalfPSU->AddNode(DCDC_coil1, 1, NULL);
