...
TGeoVolumeAssembly *Barrel::createBarrel() {
  ...
  TGeoTranslation transrail2(-43.70, -23.986, 20.350); // R = 498.5; H = 11
  ...
  495.00, 496.00 , 823.75 ,219.2834, 225.8318); TGeoVolume *parallelpipe3 =
  gGeoManager->MakeTubs("Parallel_Pipe3", kMeAl, 495.00, 496.00 , 823.750
  ,314.1681, 320.7165); TGeoVolume *parallelpipe1 =
  gGeoManager->MakeTubs("Parallel_Pipe1", kMeAl, 503.00, 504.00 , 823.750
  ,219.2834, 225.8318); TGeoVolume *parallelpipe4 =
  gGeoManager->MakeTubs("Parallel_Pipe4", kMeAl, 503.00, 504.00 , 823.750
  ,314.1681, 320.7165); TGeoVolume *parallelpipe2 =
  gGeoManager->MakeBox("Parallel_Pipe2", kMeAl, 0.5, 4.5, 823.75);
  */
  ...
  /*  parallelpipe0->SetLineColor(kOrange-6);
    ...
    parallelpipe2->SetLineColor(kOrange-6);
    parallelpipe3->SetLineColor(kOrange-6);
    parallelpipe4->SetLineColor(kOrange-6);
    */
  // adding nodes
  ...
  /*  BarrelVolume->AddNode(parallelpipe0,2,new TGeoTranslation(0.0,0.0,
  823.75)); BarrelVolume->AddNode(parallelpipe3,2,new TGeoTranslation(0.0,0.0,
  823.75)); BarrelVolume->AddNode(parallelpipe1,2,new TGeoTranslation(0.0,0.0,
  823.75)); BarrelVolume->AddNode(parallelpipe4,2,new TGeoTranslation(0.0,0.0,
  823.75)); BarrelVolume->AddNode(parallelpipe2,2,pos_pipe0);
  BarrelVolume->AddNode(parallelpipe2,2,pos_pipe1);
  BarrelVolume->AddNode(parallelpipe2,2,pos_pipe2);
  BarrelVolume->AddNode(parallelpipe2,2,pos_pipe3);*/
  // set Wires
  ...
  // coloring
  BarrelWiresA->SetLineColor(kRed);
  BarrelWiresB->SetLineColor(kRed);
  BarrelWiresC->SetLineColor(kRed);
