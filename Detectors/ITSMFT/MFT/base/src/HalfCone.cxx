...
TGeoVolumeAssembly* HalfCone::createHalfCone(Int_t half)
{
  ...
  TGeoRotation* rot_180yR =
    new TGeoRotation("rot_180yR", 180, -180, 0);
  ...
  TGeoRotation* rot_halfR =
    new TGeoRotation("rot_halfR", 180, 180, 0);
  ...
  TGeoCombiTrans* combi_bord1 =
    new TGeoCombiTrans(-26.7995, -13.0215, 0, rot1_bord1);
  ...
  //// 3) modi adding new knee new element 2
  ...
  TGeoCombiTrans* combi_RL_pent = new TGeoCombiTrans(
    8.3, 30.705, 1.125 - 0.025, rot_X90);
  ...
  // 3b) modi adding new knee new element 2
  ...
  TGeoTranslation* tr_mb_box =
    new TGeoTranslation("tr_mb_box", 24.05, 9.55, 0);
  ...
  TGeoTranslation* tr1_mb =
    new TGeoTranslation("tr1_mb", 18.48, 6.1, 0.);
  tr1_mb->RegisterYourself();

  TGeoTranslation* tr2_mb =
    new TGeoTranslation("tr2_mb", 24.15, 8.9, 0.);
  ...
  auto* fwb_Volume =
    new TGeoVolume("fwb_Volume", fwb_Shape_1, malu5083);
