...
class PrimaryVertexContext
    final
    {
      public:
        ...
        std::array<std::vector<bool>, Constants::ITS::LayersNumber>& getUsedClusters();
    ...
    inline std::array<std::vector<bool>, Constants::ITS::LayersNumber>& PrimaryVertexContext::getUsedClusters()
    {
      return mUsedClusters;
    }
