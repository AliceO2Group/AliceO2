...
class TrackerTraits
{
 ...
 private:
  ...
  bool fitTrack(TrackITSExt& track,
                int start,
                int end,
                int step,
                bool useBxByBz = false,
                float chi2clcut = o2::constants::math::VeryBig,
                float chi2ndfcut = o2::constants::math::VeryBig,
                float maxQoverPt = o2::constants::math::VeryBig,
                int nCl = 0);
