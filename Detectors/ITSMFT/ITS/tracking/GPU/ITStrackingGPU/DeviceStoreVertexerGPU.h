...
#ifndef ITSTRACKINGGPU_DEVICESTOREVERTEXERGPU_H_
#define ITSTRACKINGGPU_DEVICESTOREVERTEXERGPU_H_
...
class DeviceStoreVertexerGPU final
{
 public:
  ...
  UniquePointer<DeviceStoreVertexerGPU> initialise(const std::array<std::vector<Cluster>, constants::its::LayersNumberVertexer>&,
                                                   const std::array<std::vector<int>, constants::its::LayersNumberVertexer>&);
...
#ifdef __CUDACC__
  GPUhd() Vector<cub::KeyValuePair<int, int>>& getTmpVertexPositionBins()
  {
    return mTmpVertexPositionBins;
  }
#endif
#ifdef __HIPCC__
  GPUhd() Vector<hipcub::KeyValuePair<int, int>>& getTmpVertexPositionBins()
  {
    return mTmpVertexPositionBins;
  }
#endif
