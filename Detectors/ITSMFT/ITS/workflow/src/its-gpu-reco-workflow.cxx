...
void customize(std::vector<o2::framework::ConfigParamSpec>& workflowOptions)
{
  ...
  std::vector<o2::framework::ConfigParamSpec> options{
    ...
    {"gpu-device", o2::framework::VariantType::Int, 2, {"use gpu device: CUDA=2,HIP=3 (default: CUDA)"}}};
...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
  ...
  auto wf = o2::its::reco_workflow_gpu::getWorkflow(useMC, trmode, gpuDevice, extDigits, extClusters, disableRootOutput, eencode);
