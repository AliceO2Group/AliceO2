...
#include "/data/zhaozhong/alice/sw/SOURCES/O2/1.0.0/0/Detectors/ITSMFT/ITS/QCWorkFlow/include/ITSQCWorkflow/HisAnalyzerSpec.h"
...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
	...
	if (isEnabled(o2::detectors::DetID::ITS)) {
		...
		LOG(INFO) << "START HISTORING";
	//	specs.emplace_back(o2::ITS::getHisAnalyzerSpec());
		LOG(INFO) << "BEEN HERE NOW BRO ORB";
	}
