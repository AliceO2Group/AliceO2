...
//
  ...
  snprintf(volname, 30, "staveCentral%d", mLayerNumber);
  ...
  snprintf(volname, 30, "%s%d", GeometryTGeo::getITSHalfStavePattern(), mLayerNumber);
...
//
  ...
  snprintf(volname, 30, "SpaceFrameVolumeLay%d", mLayerNumber);
