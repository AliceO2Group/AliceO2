...
void Xcheck()
{
  ...
  for (int iEntry = 0; iEntry < old_entries; iEntry++)
  {
    ...
    {
      std::sort(old_Clusters0->begin(), old_Clusters0->end(), [](o2::its::Cluster &c1, o2::its::Cluster &c2)
                { return c1.xCoordinate < c2.xCoordinate; });
      std::sort(tf_Clusters0->begin(), tf_Clusters0->end(), [](o2::its::Cluster &c1, o2::its::Cluster &c2)
                { return c1.xCoordinate < c2.xCoordinate; });
    ...
    {
      std::sort(old_Clusters1->begin(), old_Clusters1->end(), [](o2::its::Cluster &c1, o2::its::Cluster &c2)
                { return c1.xCoordinate < c2.xCoordinate; });
      std::sort(tf_Clusters1->begin(), tf_Clusters1->end(), [](o2::its::Cluster &c1, o2::its::Cluster &c2)
                { return c1.xCoordinate < c2.xCoordinate; });
    ...
    {
      std::sort(old_Clusters2->begin(), old_Clusters2->end(), [](o2::its::Cluster &c1, o2::its::Cluster &c2)
                { return c1.xCoordinate < c2.xCoordinate; });
      std::sort(tf_Clusters2->begin(), tf_Clusters2->end(), [](o2::its::Cluster &c1, o2::its::Cluster &c2)
                { return c1.xCoordinate < c2.xCoordinate; });
    ...
    std::sort(old_tracklets01->begin(), old_tracklets01->end(), [](o2::its::Tracklet &c1, o2::its::Tracklet &c2)
              { return c1.tanLambda < c2.tanLambda; });
    std::sort(tf_tracklets01->begin(), tf_tracklets01->end(), [](o2::its::Tracklet &c1, o2::its::Tracklet &c2)
              { return c1.tanLambda < c2.tanLambda; });
    ...
    {
      std::sort(old_tracklets12->begin(), old_tracklets12->end(), [](o2::its::Tracklet &c1, o2::its::Tracklet &c2)
                { return c1.tanLambda < c2.tanLambda; });
      std::sort(tf_tracklets12->begin(), tf_tracklets12->end(), [](o2::its::Tracklet &c1, o2::its::Tracklet &c2)
                { return c1.tanLambda < c2.tanLambda; });
    ...
    sort(old_lines->begin(), old_lines->end(), [](o2::its::Line &l1, o2::its::Line &l2)
         { return l1.originPoint[0] < l2.originPoint[0]; });
    sort(tf_lines->begin(), tf_lines->end(), [](o2::its::Line &l1, o2::its::Line &l2)
         { return l1.originPoint[0] < l2.originPoint[0]; });
