...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
  ...
  GID::mask_t allowedSrc = GID::getSourcesMask("ITS,MFT,MCH,TPC,ITS-TPC,TPC-TOF,TPC-TRD,ITS-TPC-TOF,ITS-TPC-TRD,TPC-TRD-TOF,ITS-TPC-TRD-TOF,MFT-MCH,FT0,FV0,FDD,FT0,FV0,FDD,ZDC,EMC,CTP,PHS");
