...
SimpleSTF::SimpleSTF(std::vector<o2f::InputRoute>&& sch, PartsRef&& pref, Messages&& msg)
  : schema{std::move(sch)}, partsRef{std::move(pref)}, messages{std::move(msg)}, record{schema, {[this](std::size_t i, std::size_t part) {           // getter for the DataRef of a part in the input "i"
                                                                                                 ...
                                                                                                 [this](std::size_t i) { // getter for the nparts in the input "i"
