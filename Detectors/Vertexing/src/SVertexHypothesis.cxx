...
void SVertex3Hypothesis::set(PID v0, PID ppos0, PID ppos1, PID pneg, float sig, float nSig, float margin, float cpt, float bz)
{
  mPIDV0 = v0;
  mPIDPosProng0 = ppos0;
  mPIDPosProng1 = ppos1;
...
void SVertex3Hypothesis::set(PID v0, PID ppos0, PID ppos1, PID pneg, const float pars[NPIDParams], float bz)
{
  set(v0, ppos0, ppos1, pneg, pars[SigmaM], pars[NSigmaM], pars[MarginM], pars[CPt], bz);
}
