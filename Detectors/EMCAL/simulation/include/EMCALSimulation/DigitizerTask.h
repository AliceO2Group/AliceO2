...
namespace o2
{
  namespace EMCAL
  {
    ...
    {
      using Digitizer = o2::EMCAL::Digitizer;
    ...
    private:
      ...
      const std::vector<o2::EMCAL::Hit>* mHitsArray = nullptr;   ///< Array of MC hits
      std::vector<o2::EMCAL::Digit> *mDigitsArray = nullptr; ///< Array of digits
