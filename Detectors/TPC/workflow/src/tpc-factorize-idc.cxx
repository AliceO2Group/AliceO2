...
WorkflowSpec defineDataProcessing(ConfigContext const& config)
{
  ...
  for (int ilane = 0; ilane < nLanes; ++ilane) {
    workflow.emplace_back(getTPCFactorizeIDCSpec(ilane, rangeCRUs, timeframes, timeframesDeltaIDC, compression, debug, usePrecisetimeStamp, sendOutputFFT, sendCCDB));
  }
  return workflow;
}
