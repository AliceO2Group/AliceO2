...
#include "TPCWorkflow/TPCCalibRawSpec.h"
...
void customize(std::vector<ConfigParamSpec>& workflowOptions)
{
  ...
  std::vector<ConfigParamSpec> options{
    ...
    {"input-calib", VariantType::String, "pedestal", {"selection string input calib type, e.g. pedestal,pulser"}},
...
WorkflowSpec defineDataProcessing(ConfigContext const& config)
{
  ...
  const std::string inputCalib = config.options().get<std::string>("input-calib");
