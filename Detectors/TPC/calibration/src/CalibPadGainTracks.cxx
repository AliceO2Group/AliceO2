...
void CalibPadGainTracks::processTracks(const int nMaxTracks)
{
  ...
  if (!mPropagateTrack) {
    refit = std::make_unique<o2::gpu::GPUO2InterfaceRefit>(mClusterIndex, mTPCCorrMapsHelper, mFieldNominalGPUBz, mTPCTrackClIdxVecInput->data(), mTPCRefitterShMap.data(), mTPCRefitterOccMap.data());
  }
