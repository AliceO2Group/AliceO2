...
class SpaceCharge
{
 ...
 private:
  ...
  AliTPCLookUpTable3DInterpolatorD* mLookUpLocalIonDriftA; ///< lookup table for local ion drift along E field on A side
  AliTPCLookUpTable3DInterpolatorD* mLookUpLocalIonDriftC; ///< lookup table for local ion drift along E field on C side
};
