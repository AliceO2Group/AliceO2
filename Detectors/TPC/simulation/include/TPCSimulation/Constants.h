/// \file Constants.h
/// \brief Definition of constexprants that should go to a (yet to be defined) parameter space
...
namespace AliceO2 {
  namespace TPC {
    ...
    const std::vector<double> BBPARAM{0.76176e-1, 10.632, 0.13279e-4, 1.8631, 1.9479};   ///< Bethe-Bloch parameters of Ne-CO2-N2 (90-10-5), value from current AliRoot TPCParam
