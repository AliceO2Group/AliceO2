...
void SpaceCharge::allocateMemory()
{
  ...
  mLookUpLocalIonDriftA = new AliTPCLookUpTable3DInterpolatorD(mNRBins, mMatrixLocalIonDriftDrA, mCoordR.data(), mNPhiBins, mMatrixLocalIonDriftDrphiA, mCoordPhi.data(), mNZSlices, mMatrixLocalIonDriftDzA, mCoordZ.data(), mInterpolationOrder);
  mLookUpLocalIonDriftC = new AliTPCLookUpTable3DInterpolatorD(mNRBins, mMatrixLocalIonDriftDrC, mCoordR.data(), mNPhiBins, mMatrixLocalIonDriftDrphiC, mCoordPhi.data(), mNZSlices, mMatrixLocalIonDriftDzC, mCoordZ.data(), mInterpolationOrder);
}
