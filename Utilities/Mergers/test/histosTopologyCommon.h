...
class HistosMergerTestGenerator
{
 ...
 public:
  ...
  HistosMergerTestGenerator(const HistosMergerTestGenerator&) = default;
  HistosMergerTestGenerator(HistosMergerTestGenerator&&) = default;
  HistosMergerTestGenerator& operator=(const HistosMergerTestGenerator&) = default;
  HistosMergerTestGenerator& operator=(HistosMergerTestGenerator&&) = default;
