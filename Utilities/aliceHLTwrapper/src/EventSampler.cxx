...
EventSampler::EventSampler(int verbosity)
  : mEventPeriod(-1), mInitialDelay(-1), mNEvents(-1), mPollingTimeout(-1), mSkipProcessing(0), mVerbosity(verbosity), mLatencyLogFileName()
{
}

EventSampler::~EventSampler() = default;
