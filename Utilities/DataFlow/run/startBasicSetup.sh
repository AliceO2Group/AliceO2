...
xterm -geometry 80x25+1000+0 -hold -e o2-subframebuilder-device --id subframeBuilder --mq-config confBasicSetup.json --self-triggered &

xterm -geometry 80x25+1500+0 -hold -e o2-timeframe-validator-device --id timeframeValidator --mq-config confBasicSetup.json --input-channel-name input &
