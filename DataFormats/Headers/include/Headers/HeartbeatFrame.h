...
struct HeartbeatFrameEnvelope : public BaseHeader {
  ...
  HeartbeatFrameEnvelope()
    : BaseHeader(sizeof(HeartbeatFrameEnvelope), sHeaderType, sSerializationMethod, sVersion), header(), trailer() {}

  HeartbeatFrameEnvelope(const HeartbeatHeader& h, const HeartbeatTrailer& t)
    : BaseHeader(sizeof(HeartbeatFrameEnvelope), sHeaderType, sSerializationMethod, sVersion), header(h), trailer(t) {}
};
