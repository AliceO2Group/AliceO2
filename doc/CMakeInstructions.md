...
Optionally it might contain a call to [o2_target_root_dictionary](../cmake/O2TargetRootDictionary.cmake) (see [Examples/ExampleModule2](../Examples/ExampleModule2/)) if the module's library requires a Root dictionary.
