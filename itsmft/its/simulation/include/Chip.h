...
namespace AliceO2 {
  ...
  namespace ITS{
    ...
    public:
      ...
      void SetChipIndex(Int_t index) { fChipIndex = index; }
      
      /// Get the chip index
      /// @return Index of the chip
      Int_t GetChipIndex() const { return fChipIndex; }
      ...
      Int_t GetNumberOfPoints() const { return fPoints.GetEntriesFast(); }
      
      /// Get the list of points assigned to this chip
      /// @return TObjArray of points
      TObjArray *GetListOfPoints() { return &fPoints; }
      ...
      Bool_t LineSegmentLocal(Int_t hitindex, Double_t &xstart, Double_t &xpoint, Double_t &ystart, Double_t &ypoint, Double_t &zstart, Double_t &zpoint, Double_t &timestart, Double_t &eloss) const;
      ...
      /// @param timestart Start time of the hit
      /// @param eloss Energy loss during the hit
      Bool_t LineSegmentGlobal(Int_t hitindex, Double_t &xstart, Double_t &xpoint, Double_t &ystart, Double_t &ypoint, Double_t &zstart, Double_t &zpoint, Double_t &timestart, Double_t &eloss) const;
