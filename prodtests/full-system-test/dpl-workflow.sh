...
has_detector HMP && ! has_detector_from_global_reader HMP && has_processing_step HMP_RECO && add_W o2-hmpid-matcher-workflow "--disable-root-input $DISABLE_ROOT_OUTPUT $DISABLE_MC"
