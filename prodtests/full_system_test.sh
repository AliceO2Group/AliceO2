...
taskwrapper ft0raw.log o2-ft0-digi2raw --file-for cru -o raw/FT0 --configKeyValues "NameConf.mCCDBServer=http://ccdb-test.cern.ch:8080"
taskwrapper fv0raw.log o2-fv0-digi2raw --file-for cru -o raw/FV0 --configKeyValues "NameConf.mCCDBServer=http://ccdb-test.cern.ch:8080"
taskwrapper fddraw.log o2-fdd-digit2raw --file-for cru -o raw/FDD --configKeyValues "NameConf.mCCDBServer=http://ccdb-test.cern.ch:8080"
